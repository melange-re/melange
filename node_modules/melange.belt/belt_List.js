...
function toArrayWithLength(x, len) {
...
function toArray(x) {
  return toArrayWithLength(x, length(x));
}
...
function reduceReverseU(l, acc, f) {
  ...
  if (len < 1000) {
    ...
    return Belt__Belt_Array.reduceReverseU(toArrayWithLength(l, len), acc, f);
  }
}
...
function reduceReverse2U(l1, l2, acc, f) {
  ...
  if (len < 1000) {
    ...
    return Belt__Belt_Array.reduceReverse2U(toArrayWithLength(l1, len), toArray(l2), acc, f);
  }
}
