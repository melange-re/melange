...
export {
  invalid_arg,
  failwith,
  Exit as Exit$extension,
  Exit,
  Match_failure as Match_failure$extension,
  Match_failure,
  Assert_failure as Assert_failure$extension,
  Assert_failure,
  Invalid_argument as Invalid_argument$extension,
  Invalid_argument,
  Failure as Failure$extension,
  Failure,
  Not_found as Not_found$extension,
  Not_found,
  Out_of_memory as Out_of_memory$extension,
  Out_of_memory,
  Stack_overflow as Stack_overflow$extension,
  Stack_overflow,
  Sys_error as Sys_error$extension,
  Sys_error,
  End_of_file as End_of_file$extension,
  End_of_file,
  Division_by_zero as Division_by_zero$extension,
  Division_by_zero,
  Sys_blocked_io as Sys_blocked_io$extension,
  Sys_blocked_io,
  Undefined_recursive_module as Undefined_recursive_module$extension,
