...
const Stdlib__Hashtbl = require("./hashtbl.js");
...
function get_data(t) {
  return Caml_external_polyfill.resolve("caml_ephe_get_data")(t);
}

function make(key, data) {
  const eph = Stdlib__Obj.Ephemeron.create(1);
  Caml_external_polyfill.resolve("caml_ephe_set_data")(eph, data);
  set_key(eph, key);
  return eph;
}
...
function query(eph, key) {
  ...
  if (k !== undefined && Caml_option.valFromOption(k) === key) {
    return Caml_external_polyfill.resolve("caml_ephe_get_data")(eph);
  }
...
function MakeSeeded(H) {
  const create = function (k, d) {
    ...
    Caml_external_polyfill.resolve("caml_ephe_set_data")(c, d);
    set_key(c, k);
    return c;
  };
    ...
    try {
      ...
      while (true) {
        ...
        if (hkey === param._0) {
          ...
          switch (match) {
            case /* ETrue */ 0 :
              Caml_external_polyfill.resolve("caml_ephe_unset_data")(c);
              set_key(c, key);
              return Caml_external_polyfill.resolve("caml_ephe_set_data")(c, info);
            case /* EFalse */ 1 :
            case /* EDead */ 2 :
              _param = next;
              continue;
...
function find(b, k) {
  ...
  if (e !== undefined) {
    return Caml_external_polyfill.resolve("caml_ephe_get_data")(Caml_option.valFromOption(e));
  }
