...
function check_suffix$1(name, suff) {
  ...
  return Curry._1(Stdlib__Bytes.unsafe_to_string, Stdlib__Bytes.lowercase_ascii(Curry._1(Stdlib__Bytes.unsafe_of_string, s))) === Curry._1(Stdlib__Bytes.unsafe_to_string, Stdlib__Bytes.lowercase_ascii(Curry._1(Stdlib__Bytes.unsafe_of_string, suff)));
}
...
function chop_suffix_opt$1(suffix, filename) {
  ...
  const r = Stdlib__String.sub(filename, len_f - len_s | 0, len_s);
  if (Curry._1(Stdlib__Bytes.unsafe_to_string, Stdlib__Bytes.lowercase_ascii(Curry._1(Stdlib__Bytes.unsafe_of_string, r))) === Curry._1(Stdlib__Bytes.unsafe_to_string, Stdlib__Bytes.lowercase_ascii(Curry._1(Stdlib__Bytes.unsafe_of_string, suffix)))) {
    return Stdlib__String.sub(filename, 0, len_f - len_s | 0);
  }
...
module.exports = {
  ...
  chop_suffix,
  chop_suffix_opt: chop_suffix_opt$2,
  extension,
  remove_extension,
  chop_extension,
  basename: basename$3,
