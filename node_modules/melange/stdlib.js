...
module.exports = {
  ...
  Exit$extension: Exit,
  Exit,
  Match_failure$extension: Match_failure,
  Match_failure,
  Assert_failure$extension: Assert_failure,
  Assert_failure,
  Invalid_argument$extension: Invalid_argument,
  Invalid_argument,
  Failure$extension: Failure,
  Failure,
  Not_found$extension: Not_found,
  Not_found,
  Out_of_memory$extension: Out_of_memory,
  Out_of_memory,
  Stack_overflow$extension: Stack_overflow,
  Stack_overflow,
  Sys_error$extension: Sys_error,
  Sys_error,
  End_of_file$extension: End_of_file,
  End_of_file,
  Division_by_zero$extension: Division_by_zero,
  Division_by_zero,
  Sys_blocked_io$extension: Sys_blocked_io,
  Sys_blocked_io,
  Undefined_recursive_module$extension: Undefined_recursive_module,
