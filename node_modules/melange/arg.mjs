            ...
            case /* Expand */ 14 :
              if (!allow_expand) {
                throw new Caml_js_exceptions.MelangeError(Stdlib.Invalid_argument, {
                    ...
                    _1: "Arg.Expand is only allowed with Arg.parse_and_expand_argv_dynamic"
                  });
              }
              const arg$7 = get_arg();
...
function parse(l, f, msg) {
  try {
    return parse_argv(undefined, Caml_sys.caml_sys_argv(), l, f, msg);
  }
  catch (raw_msg){
...
function parse_dynamic(l, f, msg) {
  try {
    return parse_argv_dynamic(undefined, Caml_sys.caml_sys_argv(), l, f, msg);
  }
  catch (raw_msg){
    const msg$1 = Caml_js_exceptions.internalToOCamlException(raw_msg);
    if (msg$1.MEL_EXN_ID === Bad) {
...
function parse_expand(l, f, msg) {
  try {
    const argv = {
      contents: Caml_sys.caml_sys_argv()
    };
    const spec = {
      contents: l
    };
...
function align(limitOpt, speclist) {
  ...
  return Stdlib__List.map((function (param) {
    ...
    if (spec.TAG === /* Symbol */ 11) {
      ...
      const spaces = Curry._1(Stdlib__Bytes.unsafe_to_string, Stdlib__Bytes.make(n, /* ' ' */32));
      return [
        kwd,
        spec,
    ...
    const spaces$1 = Curry._1(Stdlib__Bytes.unsafe_to_string, Stdlib__Bytes.make(diff, /* ' ' */32));
