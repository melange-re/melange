...
function get(a, i) {
  ...
  if (v === a.dummy) {
    ...
    return Curry._1(Dummy_unsafe_get, v);
  }
}
...
function set(a, i, x) {
  ...
  if (i >= length) {
    ...
    return Caml_array.set(arr, i, Curry._1(Dummy_of_val, x));
  }
}
...
function find_last(a) {
  ...
  const i = length - 1 | 0;
  const v = arr[i];
  return Caml_option.some(v === a.dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v));
}
...
function pop_last(a) {
  ...
  const v = arr[last];
  const v$1 = v === dummy ? missing_element(last, length) : Curry._1(Dummy_unsafe_get, v);
  arr[last] = Curry._1(Dummy_of_dummy, dummy);
  a.length = last;
  return v$1;
}
...
function remove_last(a) {
  ...
  if (last >= 0) {
    a.length = last;
    return Caml_array.set(a.arr, last, Curry._1(Dummy_of_dummy, a.dummy));
  }
...
function truncate(a, n) {
  ...
  if (length <= n) {
    ...
    a.length = n;
    return Stdlib__Array.fill(arr, n, length - n | 0, Curry._1(Dummy_of_dummy, a.dummy));
  }
}
...
function add_last(a, x) {
  const length = a.length;
  const arr = a.arr;
  if (length >= arr.length ? false : (a.length = length + 1 | 0, arr[length] = Curry._1(Dummy_of_val, x), true)) {
    return;
  }
  while (true) {
    ...
    const arr$1 = a.arr;
    if (length$1 >= arr$1.length ? false : (a.length = length$1 + 1 | 0, arr$1[length$1] = Curry._1(Dummy_of_val, x), true)) {
      return;
    }
    continue;
  };
...
function blit_assume_room(src, src_pos, src_length, dst, dst_pos, dst_length, blit_length) {
  ...
  try {
    return Curry._7(Dummy_Array.blit, src_arr, src.dummy, src_pos, dst_arr, dst.dummy, dst_pos, blit_length);
  }
  catch (raw_i){
...
function iter_(fname, f, a) {
  ...
  for (let i = 0; i < length; ++i) {
    const v = arr[i];
    Curry._1(f, v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v));
  }
...
function iteri(f, a) {
  ...
  for (let i = 0; i < length; ++i) {
    const v = arr[i];
    Curry._2(f, i, v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v));
  }
...
function map(f, a) {
  ...
  const arr_out = Caml_array.make(length, Curry._1(Dummy_of_dummy, dummy));
  for (let i = 0; i < length; ++i) {
    const v = arr_in[i];
    arr_out[i] = Curry._1(Dummy_of_val, Curry._1(f, v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v)));
  }
  const res = {
    length: length,
    arr: arr_out,
...
function mapi(f, a) {
  ...
  for (let i = 0; i < length; ++i) {
    const v = arr_in[i];
    arr_out[i] = Curry._1(Dummy_of_val, Curry._2(f, i, v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v)));
  }
  const res = {
    length: length,
    arr: arr_out,
...
function fold_left(f, acc, a) {
  ...
  for (let i = 0; i < length; ++i) {
    const v = arr[i];
    const v$1 = v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v);
    r = Curry._2(f, r, v$1);
  }
...
function exists(p, a) {
  ...
  const loop = function (p, arr, dummy, _i, length) {
    while (true) {
      ...
      const v = arr[i];
      if (Curry._1(p, v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v))) {
        return true;
      }
      _i = i + 1 | 0;
      continue;
...
function exists2(p, a1, a2) {
  ...
  const loop = function (p, arr1, dummy1, arr2, dummy2, _i, length) {
    while (true) {
      ...
      const v = arr1[i];
      const v$1 = arr2[i];
      if (Curry._2(p, v === dummy1 ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v), v$1 === dummy2 ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v$1))) {
        return true;
      }
      _i = i + 1 | 0;
      continue;
...
function mem(x, a) {
  ...
  const loop = function (_i) {
    while (true) {
      ...
      const v = arr[i];
      if (Caml_obj.caml_equal(v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v), x)) {
        return true;
      }
      _i = i + 1 | 0;
      continue;
...
function memq(x, a) {
  ...
  const loop = function (_i) {
    while (true) {
      ...
      const v = arr[i];
      if ((
          v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v)
        ) === x) {
        return true;
      }
      _i = i + 1 | 0;
...
function find_opt(p, a) {
  ...
  const loop = function (_i) {
    while (true) {
      ...
      const v = arr[i];
      const x = v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v);
      if (Curry._1(p, x)) {
        return Caml_option.some(x);
      }
      _i = i + 1 | 0;
...
function find_map(p, a) {
  ...
  const loop = function (_i) {
    while (true) {
      ...
      const v = arr[i];
      const r = Curry._1(p, v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v));
      if (r !== undefined) {
        return r;
      }
      _i = i + 1 | 0;
...
function find_mapi(p, a) {
  ...
  const loop = function (_i) {
    while (true) {
      ...
      const v = arr[i];
      const r = Curry._2(p, i, v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v));
      if (r !== undefined) {
        return r;
      }
      _i = i + 1 | 0;
...
function equal(eq, a1, a2) {
  ...
  const loop = function (_i) {
    while (true) {
      ...
      const v = arr1[i];
      const v$1 = arr2[i];
      if (!Curry._2(eq, v === dum1 ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v), v$1 === dum2 ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v$1))) {
        return false;
      }
      _i = i + 1 | 0;
      continue;
...
function compare(cmp, a1, a2) {
  ...
  const loop = function (_i) {
    while (true) {
      ...
      const v = arr1[i];
      const v$1 = arr2[i];
      const c = Curry._2(cmp, v === dum1 ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v), v$1 === dum2 ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v$1));
      if (c !== 0) {
        return c;
      }
      _i = i + 1 | 0;
...
function to_list(a) {
  ...
  for (let i = length - 1 | 0; i >= 0; --i) {
    const v = arr[i];
    l = {
      hd: v === dummy ? missing_element(i, length) : Curry._1(Dummy_unsafe_get, v),
      tl: l
    };
  }
