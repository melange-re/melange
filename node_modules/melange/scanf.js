...
function name_of_input(ib) {
  ...
  if (/* tag */ typeof _ic !== "object" && typeof _ic !== "function") {
...
function close_in(ib) {
  ...
  if (/* tag */ typeof ic !== "object" && typeof ic !== "function") {
    return;
  ...
  while (true) {
    ...
    switch (fmt.TAG) {
      ...
      case /* Formatting_gen */ 18 :
        ...
        continue;
      case /* Reader */ 19 :
        if (/* tag */ typeof readers !== "object" && typeof readers !== "function") {
          throw new Caml_js_exceptions.MelangeError("Invalid_argument", {
              MEL_EXN_ID: "Invalid_argument",
      ...
      case /* Scan_char_set */ 20 :
        ...
        if (!/* tag */ (typeof match$5 !== "object" && typeof match$5 !== "function") && match$5.TAG === /* Formatting_lit */ 17) {
      ...
      case /* Ignored_param */ 23 :
        ...
        if (!/* tag */ (typeof match$7 !== "object" && typeof match$7 !== "function")) {
          return match$7._1;
        }
        throw new Caml_js_exceptions.MelangeError("Assert_failure", {
            MEL_EXN_ID: "Assert_failure",
...
function kscanf_gen(ib, ef, af, param) {
  ...
  const apply = function (_f, _args) {
    while (true) {
      const args = _args;
      const f = _f;
      if (/* tag */ typeof args !== "object" && typeof args !== "function") {
        return f;
      }
      _args = args._1;
  ...
  const k = function (readers, f) {
    ...
    try {
      ...
      if (exc.MEL_EXN_ID === Stdlib.Failure$extension) {
        return Curry._2(ef, ib, exc);
      }
      if (exc.MEL_EXN_ID === Stdlib.End_of_file$extension) {
        return Curry._2(ef, ib, exc);
      }
      if (exc.MEL_EXN_ID === Stdlib.Invalid_argument$extension) {
