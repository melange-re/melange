...
function lfprintf(oc, param, args) {
  CamlinternalFormat.make_lprintf((function (param) {
    return CamlinternalFormat.output_acc(oc, param);
  }), /* End_of_acc */ 0, param._0, args);
}

function lbprintf(b, param, args) {
  CamlinternalFormat.make_lprintf((function (param) {
    return CamlinternalFormat.bufput_acc(b, param);
  }), /* End_of_acc */ 0, param._0, args);
}

function lprintf(fmt, args) {
  lfprintf(Stdlib.stdout, fmt, args);
}

function leprintf(fmt, args) {
  lfprintf(Stdlib.stderr, fmt, args);
}
