        ...
        switch (c) {
          ...
          case 59 :
            ...
            try {
              ...
              const exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
              if (exn.MEL_EXN_ID === Stdlib.Not_found$extension || exn.MEL_EXN_ID === Stdlib.Failure$extension) {
                match = [
                  str_ind$1,
                  {
                    TAG: /* Break */ 0,
          ...
          case 60 :
            ...
            try {
              ...
              if (exn$1.MEL_EXN_ID === Stdlib.Not_found$extension || exn$1.MEL_EXN_ID === Stdlib.Failure$extension) {
                match$5 = undefined;
              } else {
                throw exn$1;
              }
