...
const of_char = Stdlib__String.of_char;
...
const take_first = Stdlib__String.take_first;

const take_last = Stdlib__String.take_last;

const drop_first = Stdlib__String.drop_first;

const drop_last = Stdlib__String.drop_last;

const cut_first = Stdlib__String.cut_first;

const cut_last = Stdlib__String.cut_last;

const take_first_while = Stdlib__String.take_first_while;

const take_last_while = Stdlib__String.take_last_while;

const drop_first_while = Stdlib__String.drop_first_while;

const drop_last_while = Stdlib__String.drop_last_while;

const cut_first_while = Stdlib__String.cut_first_while;

const cut_last_while = Stdlib__String.cut_last_while;

const split_first = Stdlib__String.split_first;

const split_last = Stdlib__String.split_last;

const split_all = Stdlib__String.split_all;

const rsplit_all = Stdlib__String.rsplit_all;
...
const find_first_index = Stdlib__String.find_first_index;

const find_last_index = Stdlib__String.find_last_index;
...
const find_first = Stdlib__String.find_first;

const find_last = Stdlib__String.find_last;

const find_all = Stdlib__String.find_all;

const rfind_all = Stdlib__String.rfind_all;

const replace_first = Stdlib__String.replace_first;

const replace_last = Stdlib__String.replace_last;

const replace_all = Stdlib__String.replace_all;
