...
import * as Caml_backtrace from "melange.js/caml_backtrace.mjs";
...
function convert_raw_backtrace(bt) {
  try {
    return Caml_backtrace.caml_convert_raw_backtrace(bt);
  }
  catch (raw_exn){
...
function print_backtrace(outchan) {
  print_raw_backtrace(outchan, Caml_backtrace.caml_get_exception_raw_backtrace());
}
...
function get_backtrace(param) {
  return raw_backtrace_to_string(Caml_backtrace.caml_get_exception_raw_backtrace());
}
...
const record_backtrace = Caml_backtrace.caml_record_backtrace;

const backtrace_status = Caml_backtrace.caml_backtrace_status;

const get_raw_backtrace = Caml_backtrace.caml_get_exception_raw_backtrace;
