...
const has_matching_custom_compare = (function(a, b) {
    if (a === null || b === null ||
...
const run_custom_compare = (function(a, b, total) {
    return a[Symbol.for("melange.runtime.custom_ops/1")].compare(a, b, total);
  }
);

function caml_compare(a, b) {
  if (has_matching_custom_compare(a, b)) {
    return run_custom_compare(a, b, true);
  }
  if (a === b) {
    return 0;
  }
...
function caml_equal(a, b) {
  if (has_matching_custom_compare(a, b)) {
    return run_custom_compare(a, b, false) === 0;
  }
  if (a === b) {
    return true;
  }
