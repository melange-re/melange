...
const caml_ba_create = (function(kind, layout, dims) {
...
const caml_ba_dim = (function(ba, n) {
...
const caml_ba_get_generic = (function(ba, indices) {
...
const caml_ba_set_generic = (function(ba, indices, value) {
    var num_dims = ba.dims.length;
    if (indices.length !== num_dims) {
      throw [0, -3, "Bigarray: wrong number of indices"];
    }
...
const caml_ba_get_1 = (function(ba, i0) {
    var offset;
    if (ba.layout === 0) {
...
const caml_ba_set_1 = (function(ba, i0, value) {
    var offset;
    if (ba.layout === 0) {
      if (i0 < 0 || i0 >= ba.dims[0])
        throw [0, -3, "Bigarray: index out of bounds"];
...
const caml_ba_get_2 = (function(ba, i0, i1) {
    var offset;
    if (ba.layout === 0) {
...
const caml_ba_set_2 = (function(ba, i0, i1, value) {
    var offset;
    if (ba.layout === 0) {
      if (i0 < 0 || i0 >= ba.dims[0] || i1 < 0 || i1 >= ba.dims[1])
        throw [0, -3, "Bigarray: index out of bounds"];
...
const caml_ba_get_3 = (function(ba, i0, i1, i2) {
    var offset;
    if (ba.layout === 0) {
      if (i0 < 0 || i0 >= ba.dims[0] || i1 < 0 || i1 >= ba.dims[1] ||
          i2 < 0 || i2 >= ba.dims[2])
...
const caml_ba_set_3 = (function(ba, i0, i1, i2, value) {
    var offset;
    if (ba.layout === 0) {
      if (i0 < 0 || i0 >= ba.dims[0] || i1 < 0 || i1 >= ba.dims[1] ||
          i2 < 0 || i2 >= ba.dims[2])
...
const caml_ba_blit = (function(src, dst) {
    dst.data.set(src.data);
  }
);

const caml_ba_sub = (function(ba, ofs, len) {
    var num_dims = ba.dims.length;
    var changed_dim;
    var mul = 1;
    if (ba.layout === 0) {
...
const caml_ba_slice = (function(ba, indices) {
    var num_dims = ba.dims.length;
...
const caml_ba_reshape = (function(ba, new_dims) {
