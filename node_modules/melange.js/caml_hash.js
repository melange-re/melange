...
const Caml_hash_primitive = require("./caml_hash_primitive.js");
...
const has_custom_hash = (function(obj) {
...
const run_custom_hash = (function(obj) {
      ...
      while (queue.length !== 0 && num > 0) {
        ...
        switch (match$1) {
          ...
          case "undefined" :
            break;
          default:
            if (has_custom_hash(obj$1)) {
              hash = Caml_hash_primitive.caml_hash_mix_int(hash, run_custom_hash(obj$1));
              num = num - 1 | 0;
            } else {
