...
function caml_lex_engine(tbls, i, buf) {
  return caml_lex_engine_aux(tbls, i, buf, new Caml_js_exceptions.MelangeError("Failure", {
      MEL_EXN_ID: "Failure",
      _1: empty_token_lit
    }));
}
...
function caml_new_lex_engine(tbl, i, buf) {
  return caml_new_lex_engine_aux(tbl, i, buf, new Caml_js_exceptions.MelangeError("Failure", {
      MEL_EXN_ID: "Failure",
      _1: empty_token_lit
    }));
}
