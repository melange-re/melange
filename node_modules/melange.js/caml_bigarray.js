...
function raise_invalid_argument(message) {
...
function raise_out_of_memory(param) {
  throw new Caml_js_exceptions.MelangeError("Out_of_memory", {
      MEL_EXN_ID: "Out_of_memory"
    });
}

const caml_double_of_float16 = (function(bytes) {
    var sign = bytes >>> 15;
...
const caml_float16_of_double = ((function() {
...
const caml_ba_is_float16 = (function(ba) { return ba.kind === 13; }
);

function caml_ba_decode(ba, value) {
  if (caml_ba_is_float16(ba)) {
    return caml_double_of_float16(value);
  } else {
    return value;
  }
}

function caml_ba_encode(ba, value) {
  if (caml_ba_is_float16(ba)) {
    return Curry._1(caml_float16_of_double, value);
  } else {
    return value;
  }
}

const caml_ba_compare = (function(a, b, total) {
...
const caml_ba_hash = (function(ba) {
...
const register_custom_ops = (function(id, compare, hash) {
...
const caml_ba_custom_ops = register_custom_ops("_bigarr02", caml_ba_compare, caml_ba_hash);

const caml_ba_create_raw = (function(kind, layout, dims, custom_ops, invalid, out_of_memory) {
...
function caml_ba_create(kind, layout, dims) {
  return caml_ba_create_raw(kind, layout, dims, caml_ba_custom_ops, raise_invalid_argument, raise_out_of_memory);
}

const caml_ba_num_dims = (function(ba) { return ba.dims.length; }
);

const caml_ba_dim_raw = (function(ba, n, invalid) {
...
function caml_ba_dim(ba, n) {
  return caml_ba_dim_raw(ba, n, raise_invalid_argument);
}

const caml_ba_dim_1 = (function(ba) { return ba.dims[0]; }
);

const caml_ba_dim_2 = (function(ba) { return ba.dims[1]; }
);

const caml_ba_dim_3 = (function(ba) { return ba.dims[2]; }
);

const caml_ba_kind = (function(ba) { return ba.kind; }
);

const caml_ba_layout = (function(ba) { return ba.layout; }
);

const caml_ba_get_generic_raw = (function(ba, indices, invalid) {
...
function caml_ba_get_generic(ba, indices) {
  return caml_ba_decode(ba, caml_ba_get_generic_raw(ba, indices, raise_invalid_argument));
}

const caml_ba_set_generic_raw = (function(ba, indices, value, invalid) {
    var num_dims = ba.dims.length;
    if (indices.length !== num_dims) {
      return invalid("Bigarray: wrong number of indices");
    }
...
function caml_ba_set_generic(ba, indices, value) {
  caml_ba_set_generic_raw(ba, indices, caml_ba_encode(ba, value), raise_invalid_argument);
}

const caml_ba_get_1_raw = (function(ba, i0, invalid) {
    var offset;
    if (ba.layout === 0) {
...
function caml_ba_get_1(ba, i0) {
  return caml_ba_decode(ba, caml_ba_get_1_raw(ba, i0, raise_invalid_argument));
}

const caml_ba_set_1_raw = (function(ba, i0, value, invalid) {
    var offset;
    if (ba.layout === 0) {
      if (i0 < 0 || i0 >= ba.dims[0])
        return invalid("Bigarray: index out of bounds");
...
const caml_ba_get_2_raw = (function(ba, i0, i1, invalid) {
    var offset;
    if (ba.layout === 0) {
...
function caml_ba_get_2(ba, i0, i1) {
  return caml_ba_decode(ba, caml_ba_get_2_raw(ba, i0, i1, raise_invalid_argument));
}

const caml_ba_set_2_raw = (function(ba, i0, i1, value, invalid) {
    var offset;
    if (ba.layout === 0) {
      if (i0 < 0 || i0 >= ba.dims[0] || i1 < 0 || i1 >= ba.dims[1])
        return invalid("Bigarray: index out of bounds");
...
const caml_ba_get_3_raw = (function(ba, i0, i1, i2, invalid) {
    var offset;
    if (ba.layout === 0) {
      if (i0 < 0 || i0 >= ba.dims[0] || i1 < 0 || i1 >= ba.dims[1] ||
          i2 < 0 || i2 >= ba.dims[2])
...
function caml_ba_get_3(ba, i0, i1, i2) {
  return caml_ba_decode(ba, caml_ba_get_3_raw(ba, i0, i1, i2, raise_invalid_argument));
}

const caml_ba_set_3_raw = (function(ba, i0, i1, i2, value, invalid) {
    var offset;
    if (ba.layout === 0) {
      if (i0 < 0 || i0 >= ba.dims[0] || i1 < 0 || i1 >= ba.dims[1] ||
          i2 < 0 || i2 >= ba.dims[2])
...
const caml_ba_fill_raw = (function(ba, value) {
    var kind = ba.kind;
    if (kind === 7) {
...
function caml_ba_fill(ba, value) {
  caml_ba_fill_raw(ba, caml_ba_encode(ba, value));
}

const caml_ba_blit_raw = (function(src, dst, invalid) {
...
function caml_ba_blit(src, dst) {
  caml_ba_blit_raw(src, dst, raise_invalid_argument);
}

const caml_ba_sub_raw = (function(ba, ofs, len, invalid) {
    var num_dims = ba.dims.length;
...
function caml_ba_sub(ba, ofs, len) {
  return caml_ba_sub_raw(ba, ofs, len, raise_invalid_argument);
}

const caml_ba_slice_raw = (function(ba, indices, invalid) {
    var num_dims = ba.dims.length;
...
function caml_ba_slice(ba, indices) {
  return caml_ba_slice_raw(ba, indices, raise_invalid_argument);
}

const caml_ba_change_layout = (function(ba, layout) {
...
const caml_ba_reshape_raw = (function(ba, new_dims, invalid) {
...
function caml_ba_reshape(ba, new_dims) {
  return caml_ba_reshape_raw(ba, new_dims, raise_invalid_argument);
}
...
/* caml_float16_of_double Not a pure module */
