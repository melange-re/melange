...
function count(param) {
  if (param !== undefined) {
    return Caml_option.valFromOption(param).count;
  } else {
    return 0;
  }
}
...
function data(param) {
  if (param !== undefined) {
    return Caml_option.valFromOption(param).data;
  } else {
    return /* Sempty */0;
  }
}
...
function fill_buff(b) {
  b.len = Stdlib__no_aliases.input(b.ic, b.buff, 0, b.buff.length);
  b.ind = 0;
...
function peek(s) {
  if (s !== undefined) {
    return peek_data(Caml_option.valFromOption(s));
  }
...
function junk(data) {
  if (data !== undefined) {
    return junk_data(Caml_option.valFromOption(data));
  }
...
function npeek(n, d) {
  if (d !== undefined) {
    var s = Caml_option.valFromOption(d);
...
function of_string(s) {
  ...
  return from(function (param) {
              ...
              if (c < s.length) {
                ...
                return Caml_option.some(Caml_string.get(s, c));
              }
...
function of_bytes(s) {
  ...
  return from(function (param) {
              ...
              if (c < s.length) {
                count.contents = count.contents + 1 | 0;
                return Caml_option.some(Caml_bytes.get(s, c));
              }
...
function dump_data(f, param) {
  if (typeof param === "number") {
    return Stdlib__no_aliases.print_string("Sempty");
  }
  switch (param.TAG | 0) {
    case /* Scons */0 :
        Stdlib__no_aliases.print_string("Scons (");
        Curry._1(f, param._0);
        Stdlib__no_aliases.print_string(", ");
        dump_data(f, param._1);
        return Stdlib__no_aliases.print_string(")");
    case /* Sapp */1 :
        Stdlib__no_aliases.print_string("Sapp (");
        dump_data(f, param._0);
        Stdlib__no_aliases.print_string(", ");
        dump_data(f, param._1);
        return Stdlib__no_aliases.print_string(")");
    case /* Slazy */2 :
        return Stdlib__no_aliases.print_string("Slazy");
    case /* Sgen */3 :
        return Stdlib__no_aliases.print_string("Sgen");
    case /* Sbuffio */4 :
        return Stdlib__no_aliases.print_string("Sbuffio");
    
  }
}

function dump(f, s) {
  Stdlib__no_aliases.print_string("{count = ");
  Stdlib__no_aliases.print_int(count(s));
  Stdlib__no_aliases.print_string("; data = ");
  dump_data(f, data(s));
  Stdlib__no_aliases.print_string("}");
  return Stdlib__no_aliases.print_newline(undefined);
}
