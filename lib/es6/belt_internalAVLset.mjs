...
function minimum(n) {
  if (n !== undefined) {
    return Caml_option.some(min0Aux(Caml_option.valFromOption(n)));
  }
...
function minUndefined(n) {
  if (n !== undefined) {
    return min0Aux(Caml_option.valFromOption(n));
  }
...
function maximum(n) {
  if (n !== undefined) {
    return Caml_option.some(max0Aux(Caml_option.valFromOption(n)));
  }
...
function maxUndefined(n) {
  if (n !== undefined) {
    return max0Aux(Caml_option.valFromOption(n));
  }
...
function keepCopyU(n, p) {
  ...
  var size = lengthNode(n$1);
  var v = new Array(size);
  var last = fillArrayWithFilter(n$1, 0, v, p);
...
function partitionCopyU(n, p) {
  ...
  fillArrayWithPartition(n$1, cursor, v, p);
