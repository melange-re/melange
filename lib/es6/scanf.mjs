...
function make_scanf(ib, _fmt, readers) {
  while(true) {
    ...
    switch (fmt.TAG | 0) {
      ...
      case /* Format_arg */13 :
          var pad_opt = fmt._0;
          scan_caml_string(pad_opt !== undefined ? pad_opt : Stdlib__no_aliases.max_int, ib);
          var s = token(ib);
          var fmt$1;
          try {
      ...
      case /* Format_subst */14 :
          ...
          scan_caml_string(pad_opt$1 !== undefined ? pad_opt$1 : Stdlib__no_aliases.max_int, ib);
          var s$1 = token(ib);
          var match$3;
          try {
      ...
      case /* Scan_char_set */20 :
          ...
          if (typeof match$5 !== "number" && match$5.TAG === /* Formatting_lit */17) {
            ...
            var width = width_opt !== undefined ? width_opt : Stdlib__no_aliases.max_int;
          ...
          var width$1 = width_opt !== undefined ? width_opt : Stdlib__no_aliases.max_int;
