...
function from_ic(scan_close_ic, iname, ic) {
  ...
  var next = function (param) {
    ...
    lim[0] = Stdlib__no_aliases.input(ic, buf, 0, len);
    if (lim[0] === 0) {
      eof[0] = true;
...
var stdin = from_ic(scan_raise_at_end, {
      TAG: /* From_file */1,
      _0: "-",
      _1: Stdlib__no_aliases.Stdlib.stdin
    }, Stdlib__no_aliases.Stdlib.stdin);
...
function open_in(param) {
  return open_in_file(Stdlib__no_aliases.Stdlib.open_in, param);
}

function open_in_bin(param) {
  return open_in_file(Stdlib__no_aliases.Stdlib.open_in_bin, param);
}
...
function check_case_insensitive_string(width, ib, error, str) {
  var lowercase = function (c) {
    if (c > 90 || c < 65) {
      ...
      return Stdlib__no_aliases.char_of_int((c - /* 'A' */65 | 0) + /* 'a' */97 | 0);
    }
  };
  var len = str.length;
  var width$1 = width;
...
function scan_string(stp, width, ib) {
  ...
  while(true) {
    ...
    if (stp !== undefined) {
      if (c === Caml_option.valFromOption(stp)) {
        ib.ic_current_char_is_valid = false;
        return width$1;
      }
...
function char_for_decimal_code(c0, c1, c2) {
  ...
  if (!(c < 0 || c > 255)) {
    return Stdlib__no_aliases.char_of_int(c);
  }
...
function scan_chars_in_char_set(char_set, scan_indic, width, ib) {
  var scan_chars = function (_i, stp) {
    while(true) {
      ...
      store_char(Stdlib__no_aliases.max_int, ib, c);
      _i = i - 1 | 0;
      continue ;
    };
  };
  ...
  var c = Caml_option.valFromOption(scan_indic);
  scan_chars(width, c);
  if (ib.ic_eof) {
    return ;
  }
...
function width_of_pad_opt(pad_opt) {
  if (pad_opt !== undefined) {
    return Caml_option.valFromOption(pad_opt);
  } else {
    return Stdlib__no_aliases.max_int;
  }
}
  ...
  while(true) {
    ...
    switch (fmt.TAG | 0) {
            ...
            switch (match.TAG | 0) {
              case /* Formatting_lit */17 :
                  ...
                  return function scan(width, param, ib) {
                    return scan_string(Caml_option.some(stp), width, ib);
                  }
                  }(stp));
      ...
      case /* Char_literal */12 :
          ...
          continue ;
      case /* Format_arg */13 :
          scan_caml_string(width_of_pad_opt(fmt._0), ib);
          var s = token(ib);
          var fmt$1;
          try {
      ...
      case /* Format_subst */14 :
          ...
          try {
            ...
            match$3 = [
              ...
              CamlinternalFormat.type_format(fmt$prime._0, CamlinternalFormatBasics.erase_rel(CamlinternalFormat.symm(fmtty)))
            ];
          }
          catch (raw_msg$1){
      ...
      case /* Scan_char_set */20 :
          ...
          if (typeof match$5 !== "number" && match$5.TAG === /* Formatting_lit */17) {
            ...
            scan_chars_in_char_set(fmt._1, Caml_option.some(match$6[0]), width, ib);
            var s$2 = token(ib);
      ...
      case /* Ignored_param */23 :
          var fmt$prime$1 = CamlinternalFormat.param_format_of_ignored_format(fmt._0, fmt._1);
          var match$7 = make_scanf(ib, fmt$prime$1._0, readers);
          if (match$7) {
            return match$7._1;
          }
          throw {
...
function pad_prec_scanf(ib, fmt, readers, pad, prec, scan, token) {
  if (typeof pad === "number") {
    if (typeof prec === "number") {
      ...
      Curry._3(scan, Stdlib__no_aliases.max_int, Stdlib__no_aliases.max_int, ib);
    ...
    Curry._3(scan, Stdlib__no_aliases.max_int, prec._0, ib);
  ...
  if (pad.TAG === /* Lit_padding */0) {
    if (pad._0) {
      ...
      if (typeof prec === "number") {
        ...
        Curry._3(scan, w, Stdlib__no_aliases.max_int, ib);
...
function kscanf(ib, ef, param) {
  ...
  var k = function (readers, f) {
    ...
    try {
      ...
      if (exc.RE_EXN_ID === Scan_failure || exc.RE_EXN_ID === Stdlib__no_aliases.Failure || exc.RE_EXN_ID === Stdlib__no_aliases.End_of_file) {
        args = {
          TAG: /* Exc */1,
          _0: exc
        };
      } else {
        if (exc.RE_EXN_ID === Stdlib__no_aliases.Invalid_argument) {
...
function bscanf_format(ib, format, f) {
  scan_caml_string(Stdlib__no_aliases.max_int, ib);
  var str = token(ib);
  var tmp;
  try {
...
function format_from_string(s, fmt) {
  return sscanf_format("\"" + ($$String.escaped(s) + "\""), fmt, (function (x) {
                return x;
              }));
}
