...
function aux_obj_compare(a, b) {
  ...
  var do_key = function (param, key) {
    ...
    if (mk !== undefined && key >= Caml_option.valFromOption(mk)) {
      return ;
    } else {
      min_key.contents = Caml_option.some(key);
      return ;
    }
  };
  var partial_arg = [
  ...
  if (match !== undefined) {
    if (match$1 !== undefined) {
      return Caml_primitive.caml_string_compare(Caml_option.valFromOption(match), Caml_option.valFromOption(match$1));
    } else {
      return -1;
    }
