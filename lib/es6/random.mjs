...
function full_init(s, seed) {
  var combine = function (accu, x) {
    return Digest.string(accu + Caml_format.caml_format_int("%d", x));
  };
...
function make_self_init(param) {
  return make(Caml_external_polyfill.resolve("caml_sys_random_seed")(undefined));
}
...
function self_init(param) {
  return full_init$1(Caml_external_polyfill.resolve("caml_sys_random_seed")(undefined));
}
