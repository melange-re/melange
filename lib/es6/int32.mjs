...
if (Sys.word_size !== 32) {
  ...
  unsigned_to_int = (function (n) {
      return Caml_option.some(n < 0 ? n + move | 0 : n);
    });
} else {
...
function of_string_opt(s) {
  try {
    return Caml_option.some(Caml_format.caml_int32_of_string(s));
  }
  catch (raw_exn){
...
function unsigned_compare(n, m) {
  return Caml_primitive.caml_int32_compare(n - -2147483648 | 0, m - -2147483648 | 0);
}
