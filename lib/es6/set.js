...
function Make(funarg) {
  ...
  var map = function (f, t) {
    ...
    if (l === l$prime && v === v$prime && r === r$prime) {
      ...
      return try_join(l$prime, v$prime, r$prime);
    }
  };
  var filter_map = function (f, t) {
    ...
    var v = t.v;
    var l = t.l;
    var l$prime = filter_map(f, l);
    var v$prime = Curry._1(f, v);
    var r$prime = filter_map(f, r);
    if (v$prime === undefined) {
      if (l$prime) {
        if (r$prime) {
          return try_join(l$prime, min_elt(r$prime), remove_min_elt(r$prime));
        } else {
          return l$prime;
        }
      } else {
    ...
    var v$prime$1 = Caml_option.valFromOption(v$prime);
    if (l === l$prime && v === v$prime$1 && r === r$prime) {
      return t;
    } else {
      return try_join(l$prime, v$prime$1, r$prime);
    }
  };
