...
import * as Hashtbl from "./hashtbl.mjs";
...
function create(param) {
  return Curry._1(Obj.ObjEph.create, 1);
}

function get_key(t) {
  return Curry._2(Obj.ObjEph.get_key, t, 0);
}

function get_key_copy(t) {
  return Curry._2(Obj.ObjEph.get_key_copy, t, 0);
}

function set_key(t, k) {
  return Curry._3(Obj.ObjEph.set_key, t, 0, k);
}

function unset_key(t) {
  return Curry._2(Obj.ObjEph.unset_key, t, 0);
}

function check_key(t) {
  return Curry._2(Obj.ObjEph.check_key, t, 0);
}

function blit_key(t1, t2) {
  return Curry._5(Obj.ObjEph.blit_key, t1, 0, t2, 0, 1);
}

function get_data(t) {
  return Curry._1(Obj.ObjEph.get_data, t);
}

function get_data_copy(t) {
  return Curry._1(Obj.ObjEph.get_data_copy, t);
}

function set_data(t, d) {
  return Curry._2(Obj.ObjEph.set_data, t, d);
}

function unset_data(t) {
  return Curry._1(Obj.ObjEph.unset_data, t);
}

function check_data(t) {
  return Curry._1(Obj.ObjEph.check_data, t);
}

function blit_data(t1, t2) {
  return Curry._2(Obj.ObjEph.blit_data, t1, t2);
}

function MakeSeeded(H) {
  var create = function (k, d) {
    var c = Curry._1(Obj.ObjEph.create, 1);
    Curry._2(Obj.ObjEph.set_data, c, d);
    set_key(c, k);
    return c;
  };
  var hash = H.hash;
  var equal = function (c, k) {
    var k$prime = Curry._2(Obj.ObjEph.get_key, c, 0);
  ...
  var set_key_data = function (c, k, d) {
    Curry._1(Obj.ObjEph.unset_data, c);
    set_key(c, k);
    return Curry._2(Obj.ObjEph.set_data, c, d);
  };
  ...
  var create$1 = function (randomOpt, initial_size) {
    var random = randomOpt !== undefined ? Caml_option.valFromOption(randomOpt) : Hashtbl.is_randomized(undefined);
  ...
  var resize = function (h) {
    ...
    var insert_bucket = function (param) {
      ...
      return Caml_array.set(ndata, nidx, /* Cons */{
                  _0: hkey,
                  _1: param._1,
  ...
  var remove = function (h, key) {
    ...
    var i = key_index(h, hkey);
    return Caml_array.set(h.data, i, remove_bucket(Caml_array.get(h.data, i)));
  };
...
function create$1(param) {
  return Curry._1(Obj.ObjEph.create, 2);
}
...
function get_key2(t) {
  return Curry._2(Obj.ObjEph.get_key, t, 1);
}

function get_key2_copy(t) {
  return Curry._2(Obj.ObjEph.get_key_copy, t, 1);
}

function set_key2(t, k) {
  return Curry._3(Obj.ObjEph.set_key, t, 1, k);
}

function unset_key2(t) {
  return Curry._2(Obj.ObjEph.unset_key, t, 1);
}

function check_key2(t) {
  return Curry._2(Obj.ObjEph.check_key, t, 1);
}
...
function blit_key2(t1, t2) {
  return Curry._5(Obj.ObjEph.blit_key, t1, 1, t2, 1, 1);
}

function blit_key12(t1, t2) {
  return Curry._5(Obj.ObjEph.blit_key, t1, 0, t2, 0, 2);
}
...
function MakeSeeded(H1, H2) {
  var create = function (param, d) {
    var c = Curry._1(Obj.ObjEph.create, 2);
    Curry._2(Obj.ObjEph.set_data, c, d);
    set_key1(c, param[0]);
    set_key2(c, param[1]);
    return c;
  ...
  var equal = function (c, param) {
    var match = Curry._2(Obj.ObjEph.get_key, c, 0);
    var match$1 = Curry._2(Obj.ObjEph.get_key, c, 1);
    if (match !== undefined && match$1 !== undefined) {
  ...
  var check_key = function (c) {
    if (Curry._2(Obj.ObjEph.check_key, c, 0)) {
      return Curry._2(Obj.ObjEph.check_key, c, 1);
    } else {
      return false;
    }
  };
...
function Make$1(H1, H2) {
  ...
  var hash$2 = function (seed, param) {
    return Curry._2(hash, seed, param[0]) + Math.imul(Curry._2(hash$1, seed, param[1]), 65599) | 0;
  };
  var equal = function (c, param) {
    var match = Curry._2(Obj.ObjEph.get_key, c, 0);
    var match$1 = Curry._2(Obj.ObjEph.get_key, c, 1);
  ...
  var clean = function (h) {
    var do_bucket = function (_param) {
      while(true) {
        ...
        if (Curry._1(check_key, param._1)) {
          return /* Cons */{
                  _0: param._0,
                  _1: param._1,
                  _2: do_bucket(param._2)
  ...
  var mem = function (h, key) {
    ...
    while(true) {
      ...
      if (param._0 === hkey) {
        var match = Curry._2(equal, param._1, key);
        if (!match) {
          return true;
        }
        _param = param._2;
  ...
  var replace_seq$1 = replace_seq;
  var create$3 = function (sz) {
    return Curry._2(create$2, false, sz);
  };
  var of_seq$1 = function (i) {
    var tbl = Curry._2(create$2, false, 16);
    Curry._2(replace_seq$1, tbl, i);
    return tbl;
  };
  return {
          create: create$3,
...
function create$2(n) {
  return Curry._1(Obj.ObjEph.create, n);
}

function get_key$1(t, n) {
  return Curry._2(Obj.ObjEph.get_key, t, n);
}

function get_key_copy$1(t, n) {
  return Curry._2(Obj.ObjEph.get_key_copy, t, n);
}

function set_key$1(t, n, k) {
  return Curry._3(Obj.ObjEph.set_key, t, n, k);
}

function unset_key$1(t, n) {
  return Curry._2(Obj.ObjEph.unset_key, t, n);
}

function check_key$1(t, n) {
  return Curry._2(Obj.ObjEph.check_key, t, n);
}

function blit_key$1(t1, o1, t2, o2, l) {
  return Curry._5(Obj.ObjEph.blit_key, t1, o1, t2, o2, l);
}
...
function MakeSeeded(H) {
  var create = function (k, d) {
    var c = Curry._1(Obj.ObjEph.create, k.length);
    Curry._2(Obj.ObjEph.set_data, c, d);
  ...
  var equal = function (c, k) {
    var len = k.length;
    var len$prime = Curry._1(Obj.ObjEph.length, c);
    if (len !== len$prime) {
      return /* EFalse */1;
    }
    var _i = len - 1 | 0;
    while(true) {
      ...
      var ki = Curry._2(Obj.ObjEph.get_key, c, i);
      if (ki === undefined) {
        return /* EDead */2;
      }
  ...
  var get_key = function (c) {
    var len = Curry._1(Obj.ObjEph.length, c);
    if (len === 0) {
      return [];
    }
    var k0 = Curry._2(Obj.ObjEph.get_key, c, 0);
    if (k0 === undefined) {
      return ;
    }
  ...
  var check_key = function (c) {
    var _i = Curry._1(Obj.ObjEph.length, c) - 1 | 0;
    while(true) {
      var i = _i;
      if (i < 0) {
        return true;
      }
      if (!Curry._2(Obj.ObjEph.check_key, c, i)) {
        return false;
      }
      _i = i - 1 | 0;
      continue ;
