...
function format_backtrace_slot(pos, slot) {
  ...
  if (slot.TAG === /* Known_location */0) {
    return Caml_option.some(Curry._7(Printf.sprintf(/* Format */{
                        _0: {
                          TAG: /* String */2,
                          _0: /* No_padding */0,
                          _1: {
    ...
    return Caml_option.some(Curry._1(Printf.sprintf(/* Format */{
                        _0: {
                          TAG: /* String */2,
                          _0: /* No_padding */0,
                          _1: {
...
function print_raw_backtrace(outchan, raw_backtrace) {
  ...
  var a = Caml_option.valFromOption(backtrace);
  for(var i = 0 ,i_finish = a.length; i < i_finish; ++i){
    var str = format_backtrace_slot(i, Caml_array.get(a, i));
    if (str !== undefined) {
...
function backtrace_slot_defname(l) {
  if (l.TAG === /* Known_location */0 && l.defname !== "") {
    return Caml_option.some(l.defname);
  }
...
function backtrace_slots(raw_backtrace) {
  ...
  var backtrace$1 = Caml_option.valFromOption(backtrace);
  ...
  var exists_usable = function (_i) {
    while(true) {
      ...
      if (usable_slot(Caml_array.get(backtrace$1, i))) {
        return true;
      }
      _i = i - 1 | 0;
      continue ;
  ...
  if (exists_usable(backtrace$1.length - 1 | 0)) {
    return Caml_option.some(backtrace$1);
  }
