...
function bool_of_string_opt(x) {
  try {
    return Caml_option.some(Stdlib__no_aliases.bool_of_string(x));
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
...
function int_of_string_opt(x) {
  try {
    return Caml_option.some(Caml_format.caml_int_of_string(x));
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
...
function float_of_string_opt(x) {
  try {
    return Caml_option.some(Caml_format.caml_float_of_string(x));
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
    if (exn.RE_EXN_ID === Stdlib__no_aliases.Failure) {
    ...
    try {
      ...
      if (s.length >= 1 && Caml_string.get(s, 0) === /* '-' */45) {
        ...
        return function no_arg(param) {
          ...
          throw {
                ...
                _1: {
                  TAG: /* Wrong */1,
                  _0: s,
                  _1: Caml_option.valFromOption(follow),
                  _2: "no argument"
                },
                Error: new Error()
              };
        ...
        return function get_arg(param) {
          if (follow !== undefined) {
            return Caml_option.valFromOption(follow);
          }
        ...
        return function treat_action(f) {
          switch (f.TAG | 0) {
            ...
            case /* Bool */1 :
                ...
                if (s$1 !== undefined) {
                  Curry._1(f._0, Caml_option.valFromOption(s$1));
                } else {
                  throw {
                        RE_EXN_ID: Stop,
                        _1: {
            ...
            case /* Int */6 :
                ...
                if (x !== undefined) {
                  Curry._1(f._0, Caml_option.valFromOption(x));
                } else {
                  throw {
                        RE_EXN_ID: Stop,
                        _1: {
            ...
            case /* Set_int */7 :
                ...
                if (x$1 !== undefined) {
                  f._0[0] = Caml_option.valFromOption(x$1);
                } else {
                  throw {
                        RE_EXN_ID: Stop,
                        _1: {
            ...
            case /* Float */8 :
                ...
                if (x$2 !== undefined) {
                  Curry._1(f._0, Caml_option.valFromOption(x$2));
                } else {
                  throw {
                        RE_EXN_ID: Stop,
                        _1: {
            ...
            case /* Set_float */9 :
                ...
                if (x$3 !== undefined) {
                  f._0[0] = Caml_option.valFromOption(x$3);
                } else {
                  throw {
                        RE_EXN_ID: Stop,
                        _1: {
...
function parse_argv_dynamic(currentOpt, argv, speclist, anonfun, errmsg) {
  var current$1 = currentOpt !== undefined ? Caml_option.valFromOption(currentOpt) : current;
...
function align(limitOpt, speclist) {
  var limit = limitOpt !== undefined ? Caml_option.valFromOption(limitOpt) : Stdlib__no_aliases.max_int;
