...
function remove0(nt, x) {
  ...
  if (x < k) {
    var l$1 = nt.l;
    if (l$1 !== undefined) {
      nt.l = remove0(Caml_option.valFromOption(l$1), x);
      return Belt_internalAVLset.balMutate(nt);
    } else {
      return nt;
    }
  ...
  var r$1 = nt.r;
  if (r$1 !== undefined) {
    nt.r = remove0(Caml_option.valFromOption(r$1), x);
    return Belt_internalAVLset.balMutate(nt);
  } else {
    return nt;
  }
...
function removeCheck0(nt, x, removed) {
  ...
  if (x < k) {
    var l$1 = nt.l;
    if (l$1 !== undefined) {
      nt.l = removeCheck0(Caml_option.valFromOption(l$1), x, removed);
      return Belt_internalAVLset.balMutate(nt);
    } else {
      return nt;
    }
  ...
  var r$1 = nt.r;
  if (r$1 !== undefined) {
    nt.r = removeCheck0(Caml_option.valFromOption(r$1), x, removed);
    return Belt_internalAVLset.balMutate(nt);
  } else {
    return nt;
  }
