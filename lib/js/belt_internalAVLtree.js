...
function heightGe(l, r) {
  if (r !== undefined) {
    if (l !== undefined) {
      return Caml_option.valFromOption(l).h >= Caml_option.valFromOption(r).h;
    } else {
      return false;
    }
  } else {
...
function bal(l, x, d, r) {
  ...
  if (hl > (hr + 2 | 0)) {
    ...
    if (treeHeight(ll) >= treeHeight(lr)) {
      return create(ll, l$1.k, l$1.v, create(lr, x, d, r));
    }
    var lr$1 = Caml_option.valFromOption(lr);
    return create(create(ll, l$1.k, l$1.v, lr$1.l), lr$1.k, lr$1.v, create(lr$1.r, x, d, r));
  }
  if (hr <= (hl + 2 | 0)) {
    return {
            k: x,
...
function minKey(n) {
  if (n !== undefined) {
    return Caml_option.some(minKey0Aux(Caml_option.valFromOption(n)));
  }
...
function minKeyUndefined(n) {
  if (n !== undefined) {
    return minKey0Aux(Caml_option.valFromOption(n));
  }
...
function maxKey(n) {
  if (n !== undefined) {
    return Caml_option.some(maxKey0Aux(Caml_option.valFromOption(n)));
  }
...
function maxKeyUndefined(n) {
  if (n !== undefined) {
    return maxKey0Aux(Caml_option.valFromOption(n));
  }
...
function minimum(n) {
  if (n !== undefined) {
    return minKV0Aux(Caml_option.valFromOption(n));
  }
...
function maximum(n) {
  if (n !== undefined) {
    return maxKV0Aux(Caml_option.valFromOption(n));
  }
...
function size(n) {
  if (n !== undefined) {
    return lengthNode(Caml_option.valFromOption(n));
  } else {
    return 0;
  }
}
