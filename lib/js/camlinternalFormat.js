...
function add_in_char_set(char_set, c) {
  var str_ind = (c >>> 3);
  var mask = (1 << (c & 7));
  return Caml_bytes.set(char_set, str_ind, Stdlib__no_aliases.char_of_int(Caml_bytes.get(char_set, str_ind) | mask));
}
...
function rev_char_set(char_set) {
  ...
  for(var i = 0; i <= 31; ++i){
    Caml_bytes.set(char_set$prime, i, Stdlib__no_aliases.char_of_int(Caml_string.get(char_set, i) ^ 255));
  }
...
function pad_of_pad_opt(pad_opt) {
  if (pad_opt !== undefined) {
    return {
            TAG: /* Lit_padding */0,
            _0: /* Right */1,
            _1: Caml_option.valFromOption(pad_opt)
          };
  } else {
    return /* No_padding */0;
  }
...
function prec_of_prec_opt(prec_opt) {
  if (prec_opt !== undefined) {
    return /* Lit_precision */{
            _0: Caml_option.valFromOption(prec_opt)
          };
  } else {
...
function char_of_fconv(cFOpt, fconv) {
  var cF = cFOpt !== undefined ? Caml_option.valFromOption(cFOpt) : /* 'F' */70;
  var match = fconv[1];
  switch (match) {
    case /* Float_f */0 :
        return /* 'f' */102;
...
function bprint_char_set(buf, char_set) {
  var print_out = function (set, _i) {
    while(true) {
      ...
      if (is_in_char_set(set, Stdlib__no_aliases.char_of_int(i))) {
        var match = Stdlib__no_aliases.char_of_int(i);
  ...
  var print_char = function (buf, i) {
    var c = Stdlib__no_aliases.char_of_int(i);
    if (c !== 37) {
      if (c !== 64) {
  ...
  var print_second = function (set, i) {
    if (is_in_char_set(set, Stdlib__no_aliases.char_of_int(i))) {
      ...
      } else if ((match > 92 || match < 46) && !is_in_char_set(set, Stdlib__no_aliases.char_of_int(i + 1 | 0))) {
        print_char(buf, i - 1 | 0);
        return print_out(set, i + 1 | 0);
      }
      if (is_in_char_set(set, Stdlib__no_aliases.char_of_int(i + 1 | 0))) {
        var i$1 = i - 1 | 0;
        var _j = i + 2 | 0;
        while(true) {
          var j = _j;
          if (j === 256 || !is_in_char_set(set, Stdlib__no_aliases.char_of_int(j))) {
            print_char(buf, i$1);
            print_char(buf, /* '-' */45);
...
function bprint_pad_opt(buf, pad_opt) {
  if (pad_opt !== undefined) {
    return buffer_add_string(buf, Caml_format.caml_format_int("%d", Caml_option.valFromOption(pad_opt)));
  }
...
function bprint_float_fmt(buf, ign_flag, fconv, pad, prec) {
  ...
  bprint_padding(buf, pad);
  bprint_precision(buf, prec);
  return buffer_add_char(buf, char_of_fconv(undefined, fconv));
}
...
function string_of_formatting_lit(formatting_lit) {
  if (typeof formatting_lit === "number") {
    ...
    switch (formatting_lit.TAG | 0) {
      ...
      case /* Scan_indic */2 :
          return "@" + Caml_bytes.bytes_to_string(Bytes.make(1, formatting_lit._0));
...
function fix_padding(padty, width, str) {
  var len = str.length;
  var width$1 = Stdlib__no_aliases.abs(width);
...
function fix_int_precision(prec, str) {
  var prec$1 = Stdlib__no_aliases.abs(prec);
  var len = str.length;
...
function convert_float(fconv, prec, x) {
  ...
  var caml_special_val = function (str) {
    var match = Stdlib__no_aliases.classify_float(x);
    if (match !== 3) {
      if (match >= 4) {
        return "nan";
      } else {
...
function make_printf(_k, _acc, _fmt) {
  while(true) {
    ...
    switch (fmt.TAG | 0) {
      ...
      case /* Bool */9 :
          return make_padding(k, acc, fmt._1, fmt._0, Stdlib__no_aliases.string_of_bool);
      case /* Flush */10 :
          _fmt = fmt._0;
          _acc = {
            TAG: /* Acc_flush */7,
      ...
      case /* Formatting_gen */18 :
          ...
          return function k$prime$1(kacc) {
            return make_printf(k, {
                        TAG: /* Acc_formatting_gen */1,
                        _0: acc,
                        _1: {
  ...
  while(true) {
    ...
    switch (acc.TAG | 0) {
      case /* Acc_formatting_lit */0 :
          ...
          output_acc(o, acc._0);
          return Stdlib__no_aliases.output_string(o, s);
      case /* Acc_formatting_gen */1 :
          var acc$prime = acc._1;
          var p = acc._0;
          if (acc$prime.TAG === /* Acc_open_tag */0) {
            output_acc(o, p);
            Stdlib__no_aliases.output_string(o, "@{");
            _acc = acc$prime._0;
            continue ;
          }
          output_acc(o, p);
    ...
    switch (exit) {
      case 1 :
          output_acc(o, acc._0);
          return Stdlib__no_aliases.output_string(o, acc._1);
      case 2 :
          output_acc(o, acc._0);
...
function fmt_ebb_of_string(legacy_behavior, str) {
  var legacy_behavior$1 = legacy_behavior !== undefined ? Caml_option.valFromOption(legacy_behavior) : true;
  ...
  var parse_char_set = function (str_ind, end_ind) {
    ...
    var add_range = function (c, c$prime) {
      for(var i = c; i <= c$prime; ++i){
        add_in_char_set(char_set, Stdlib__no_aliases.char_of_int(i));
      }
  ...
  var parse_conversion = function (pct_ind, str_ind, end_ind, plus, hash, space, ign, pad, prec, padprec, symb) {
    ...
    var opt_of_pad = function (c, pad) {
      ...
      switch (pad._0) {
        case /* Left */0 :
            if (legacy_behavior$1) {
              return Caml_option.some(pad._1);
            } else {
              return incompatible_flag(pct_ind, str_ind, c, "'-'");
            }
        case /* Right */1 :
    ...
    var get_prec_opt = function (param) {
      ...
      if (typeof prec === "number") {
        ...
        return Caml_option.some(prec._0);
      }
    };
    var fmt_result;
    var exit = 0;
      ...
      switch (symb) {
        ...
        case 40 :
            ...
            if (ign_used[0] = true, ign) {
              var ignored_0 = opt_of_pad(/* '_' */95, (pad_used[0] = true, pad));
              var ignored = {
                TAG: /* Ignored_format_subst */9,
                _0: ignored_0,
                _1: sub_fmtty
              ...
              fmt_result = /* Fmt_EBB */{
                _0: {
                  TAG: /* Format_subst */14,
                  _0: opt_of_pad(/* '(' */40, (pad_used[0] = true, pad)),
                  _1: sub_fmtty,
                  _2: fmt_rest$2
                }
              };
        ...
        case 67 :
            ...
            fmt_result = (ign_used[0] = true, ign) ? /* Fmt_EBB */({
                  _0: {
                    TAG: /* Ignored_param */23,
        ...
        case 83 :
            ...
            if (ign_used[0] = true, ign) {
              var ignored$2 = {
                ...
                _0: opt_of_pad(/* '_' */95, (pad_used[0] = true, padprec))
              };
              fmt_result = /* Fmt_EBB */{
                _0: {
                  TAG: /* Ignored_param */23,
        ...
        case 91 :
            ...
            if (ign_used[0] = true, ign) {
              var ignored_0$1 = opt_of_pad(/* '_' */95, (pad_used[0] = true, pad));
              var ignored$3 = {
              ...
              fmt_result = /* Fmt_EBB */{
                _0: {
                  TAG: /* Scan_char_set */20,
                  _0: opt_of_pad(/* '[' */91, (pad_used[0] = true, pad)),
                  _1: char_set,
                  _2: fmt_rest$10
                }
              };
        ...
        case 99 :
            ...
            var _n = opt_of_pad(/* 'c' */99, (pad_used[0] = true, pad));
            fmt_result = _n !== undefined ? (
                Caml_option.valFromOption(_n) !== 0 ? (
        ...
        case 123 :
            ...
            if (ign_used[0] = true, ign) {
              var ignored_0$2 = opt_of_pad(/* '_' */95, (pad_used[0] = true, pad));
              var ignored$5 = {
                TAG: /* Ignored_format_arg */8,
                _0: ignored_0$2,
                _1: sub_fmtty$1
              ...
              fmt_result = /* Fmt_EBB */{
                _0: {
                  TAG: /* Format_arg */13,
                  _0: opt_of_pad(/* '{' */123, (pad_used[0] = true, pad)),
                  _1: sub_fmtty$1,
                  _2: fmt_rest$20
                }
              };
    ...
    switch (exit$2) {
      case 7 :
          ...
          if (ign_used[0] = true, ign) {
            var ignored_1 = opt_of_pad(/* '_' */95, (pad_used[0] = true, pad));
            var ignored$6 = {
              TAG: /* Ignored_int */2,
              _0: iconv,
              _1: ignored_1
            ...
            var match$3 = make_padprec_fmt_ebb(get_int_pad(undefined), (prec_used[0] = true, prec), fmt_rest$22);
            fmt_result = /* Fmt_EBB */{
              _0: {
                TAG: /* Int */4,
                _0: iconv,
    ...
    switch (exit$1) {
      case 2 :
          ...
          if (ign_used[0] = true, ign) {
            var ignored_0$3 = opt_of_pad(/* '_' */95, (pad_used[0] = true, pad));
            ...
            var match$4 = make_padprec_fmt_ebb((pad_used[0] = true, pad), (prec_used[0] = true, prec), fmt_rest$26);
            fmt_result = /* Fmt_EBB */{
              _0: {
                TAG: /* Float */8,
                _0: fconv,
      ...
      case 6 :
          if (symb >= 108) {
            if (symb >= 111) {
              ...
              switch (symb) {
                case 108 :
                    ...
                    if (ign_used[0] = true, ign) {
                      var ignored_1$2 = opt_of_pad(/* '_' */95, (pad_used[0] = true, pad));
                      var ignored$10 = {
                        TAG: /* Ignored_int32 */3,
                        _0: iconv$1,
                        _1: ignored_1$2
                      ...
                      var match$6 = make_padprec_fmt_ebb(get_int_pad(undefined), (prec_used[0] = true, prec), fmt_rest$31);
                      fmt_result = /* Fmt_EBB */{
                        _0: {
                          TAG: /* Int32 */5,
                          _0: iconv$1,
                ...
                case 110 :
                    ...
                    if (ign_used[0] = true, ign) {
                      var ignored_1$3 = opt_of_pad(/* '_' */95, (pad_used[0] = true, pad));
                      var ignored$11 = {
                      ...
                      var match$7 = make_padprec_fmt_ebb(get_int_pad(undefined), (prec_used[0] = true, prec), fmt_rest$33);
                      fmt_result = /* Fmt_EBB */{
                        _0: {
                          TAG: /* Nativeint */6,
                          _0: iconv$2,
            ...
            if (ign_used[0] = true, ign) {
              var ignored_1$4 = opt_of_pad(/* '_' */95, (pad_used[0] = true, pad));
              var ignored$12 = {
                TAG: /* Ignored_int64 */5,
                _0: iconv$3,
                _1: ignored_1$4
              ...
              var match$8 = make_padprec_fmt_ebb(get_int_pad(undefined), (prec_used[0] = true, prec), fmt_rest$35);
              fmt_result = /* Fmt_EBB */{
                _0: {
                  TAG: /* Int64 */7,
                  _0: iconv$3,
    ...
    if (!legacy_behavior$1) {
      ...
      if (!pad_used[0] && Caml_obj.caml_notequal(/* Padding_EBB */{
              _0: pad
            }, /* Padding_EBB */{
              _0: /* No_padding */0
            })) {
        ...
        switch (c) {
          ...
          case 59 :
              ...
              try {
                ...
                var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
                if (exn.RE_EXN_ID === Stdlib__no_aliases.Not_found || exn.RE_EXN_ID === Stdlib__no_aliases.Failure) {
                  match = [
                    str_ind$1,
                    {
                      TAG: /* Break */0,
          ...
          case 60 :
              ...
              try {
                ...
                if (exn$1.RE_EXN_ID === Stdlib__no_aliases.Not_found || exn$1.RE_EXN_ID === Stdlib__no_aliases.Failure) {
                  match$5 = undefined;
                } else {
                  throw exn$1;
                }
              ...
              if (match$5 !== undefined) {
                var match$8 = Caml_option.valFromOption(match$5);
                var next_ind$1 = match$8[0];
