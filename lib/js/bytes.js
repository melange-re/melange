...
function of_seq(i) {
  ...
  var resize = function (param) {
    var new_len = Caml_primitive.caml_int_min((buf[0].length << 1), Sys.max_string_length);
    if (buf[0].length === new_len) {
      throw {
            RE_EXN_ID: "Failure",
  ...
  Seq.iter((function (c) {
          ...
          Caml_bytes.set(buf[0], n[0], c);
          n.contents = n.contents + 1 | 0;
          
        }), i);
  return sub(buf[0], 0, n[0]);
}
