...
function chop_suffix_opt(suffix, filename) {
  ...
  if (r === suffix) {
    return Caml_option.some($$String.sub(filename, 0, len_f - len_s | 0));
  }
...
function quote_command(cmd, stdin, stdout, stderr, args) {
  return $$String.concat(" ", List.map(quote, {
            ...
            stdin !== undefined ? " <" + generic_quote("'\\''", Caml_option.valFromOption(stdin)) : ""
          ) + ((
              stdout !== undefined ? " >" + generic_quote("'\\''", Caml_option.valFromOption(stdout)) : ""
            ) + (
              stderr !== undefined ? (
                  Caml_obj.caml_equal(stderr, stdout) ? " 2>&1" : " 2>" + generic_quote("'\\''", Caml_option.valFromOption(stderr))
                ) : ""
            )));
}
              ...
              tl: {
                ...
                tl: {
                  ...
                  tl: {
                    ...
                    tl: {
                      hd: stdin !== undefined ? " <" + quote_cmd_filename(Caml_option.valFromOption(stdin)) : "",
                      tl: {
                        hd: stdout !== undefined ? " >" + quote_cmd_filename(Caml_option.valFromOption(stdout)) : "",
                        tl: {
                          hd: stderr !== undefined ? (
                              Caml_obj.caml_equal(stderr, stdout) ? " 2>&1" : " 2>" + quote_cmd_filename(Caml_option.valFromOption(stderr))
                            ) : "",
                          tl: {
                            hd: "\"",
                            tl: /* [] */0
...
function temp_file(temp_dirOpt, prefix, suffix) {
  var temp_dir = temp_dirOpt !== undefined ? Caml_option.valFromOption(temp_dirOpt) : current_temp_dir_name[0];
  var _counter = 0;
  while(true) {
...
function open_temp_file(modeOpt, permsOpt, temp_dirOpt, prefix, suffix) {
  var mode = modeOpt !== undefined ? Caml_option.valFromOption(modeOpt) : ({
        hd: /* Open_text */7,
        tl: /* [] */0
      });
  var perms = permsOpt !== undefined ? Caml_option.valFromOption(permsOpt) : 384;
  var temp_dir = temp_dirOpt !== undefined ? Caml_option.valFromOption(temp_dirOpt) : current_temp_dir_name[0];
  var _counter = 0;
  while(true) {
    var counter = _counter;
