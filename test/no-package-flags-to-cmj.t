...
Build cmjs
  ...
  $ melc $MEL_STDLIB_FLAGS -bs-stop-after-cmj lib/a.ml -o lib/.objs/melange/a.cmj

  $ melc $MEL_STDLIB_FLAGS -I lib/.objs/melange -bs-stop-after-cmj app/b.ml -o app/.objs/melange/b.cmj

Linking step

  $ melc $MEL_STDLIB_FLAGS -bs-package-output lib/ lib/.objs/melange/a.cmj -o output/lib/a.js
...
`-bs-module-type` flag)
  ...
  $ melc $MEL_STDLIB_FLAGS -bs-package-output es6:app/:.mjs -I lib/.objs/melange -I output/lib app/.objs/melange/b.cmj -o output/app/cjs_file.js
...
If we don't pass the -I flag to the folder where the dependency .js files are placed, it will fail
  ...
  $ melc $MEL_STDLIB_FLAGS -bs-package-output app/ -I lib/.objs/melange app/.objs/melange/b.cmj -o output/app/b.js
  File "_none_", line 1:
