...
If we pass some file extension or module system in `-bs-package-output`, it gets ignored

  $ melc -bs-package-output es6:app/:.mjs -nopervasives -I lib/.objs/melange -I output/lib app/.objs/melange/b.cmj -o output/app/cjs_file.js
  $ cat output/app/cjs_file.mjs
  cat: output/app/cjs_file.mjs: No such file or directory
  [1]
