...
Build cmjs
  ...
  $ melc $BSPKG -bs-stop-after-cmj lib/a.ml -o lib/.objs/melange/lib__A.cmj

  $ melc $BSPKG -I lib/.objs/melange -bs-stop-after-cmj app/B.ml -o app/.objs/melange/melange__B.cmj
...
- module B was produced by B.ml, so output is B.js
  ...
  $ melc $BSPKG -bs-package-output app/ -I lib/.objs/melange -I output/lib app/.objs/melange/melange__B.cmj -o output/app/B.js
  $ melc $BSPKG -bs-package-output app/ -I lib/.objs/melange -I output/lib app/.objs/melange/melange__B.cmj -o output/app/B.js
