...
Build cmjs
  ...
  $ melc -bs-package-output lib/ -bs-stop-after-cmj lib/a.ml -o lib/.objs/melange/lib__A.cmj

  $ melc -bs-package-output app/ -I lib/.objs/melange -bs-stop-after-cmj app/B.ml -o app/.objs/melange/melange__B.cmj
