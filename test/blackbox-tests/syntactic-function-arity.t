         ...
         (function a/273
           (function b/274[int] : int
             (+ (apply (field_mut :value/2 (global Stdlib__Option!)) a/273 0)
               b/274)))
       sum_optional_default/297 =
         (function *opt*/301
           (let
             (a/299 =[int]
                (if (#is_not_none *opt*/301)
                  (#val_from_unnest_option *opt*/301) 2))
             (function b/300[int] : int (+ a/299 b/300)))))
      (makeblock 0module/exports sum_optional/271 sum_optional_default/297)))
  // Generated by Melange
  'use strict';
