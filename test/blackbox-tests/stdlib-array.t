Test cases for stdlib Array
  ...
  let t = Caml_array.make_float(10);
  
  let t2 = Stdlib__Array.init(10, (function (prim) {
          return prim;
        }));
  
  let m = Stdlib__Array.make_matrix(2, 2, undefined);
  
  let x = Stdlib__Array.append([2], [3]);
  
  let c = Stdlib__Array.concat({
        hd: [1],
        tl: {
          hd: [2],
          tl: /* [] */0
  ...
  let s = Stdlib__Array.sub(c, 1, 1);
  
  let s2 = Stdlib__Array.copy(s);
  
  Stdlib__Array.fill(s, 0, 2, 42);
  
  let fl = Caml_array.make_float(3);
