...
Skip over the temporary file name printed in the error trace
  ...
  $ melc -ppx melppx -bs-eval 'let bla4 foo x y= foo##(method1 x y [@bs])' 2>&1 | grep -v -e Command -e File
  ...
  $ melc -ppx melppx -bs-eval 'external mk : int -> ([`a|`b [@bs.string]]) = "mk" [@@bs.val]' 2>&1 | grep -v -e Command -e File
  ...
  > EOF
  $ melc -ppx melppx x.ml 2>&1 | grep -v -e Command
  ...
  $ melc -ppx melppx -bs-eval 'external mk : int -> ([`a|`b] [@bs.string]) = "" [@@bs.val]' 2>&1 | grep -v -e File -e Command
  ...
  $ melc -ppx melppx -bs-eval 'let bla4 foo x y = foo##(method1 x y [@bs])' 2>&1 | grep -v -e File -e Command
  1 | let bla4 foo x y = foo##(method1 x y [@bs])
                                             ^^
  Error (warning 101 [unused-bs-attributes]): Unused attribute: bs
  This means such annotation is not annotated properly. 
  ...
  $ melc -ppx melppx -bs-eval "type -'a t = {k : 'a } [@@bs.deriving abstract]" 2>&1 | grep -v File
