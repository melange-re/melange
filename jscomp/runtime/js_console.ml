...
external info : 'a -> unit = "info" [@@bs.val] [@@bs.scope "console"]
external info2 : 'a -> 'b -> unit = "info" [@@bs.val] [@@bs.scope "console"]
...
external warn : 'a -> unit = "warn" [@@bs.val] [@@bs.scope "console"]
external warn2 : 'a -> 'b -> unit = "warn" [@@bs.val] [@@bs.scope "console"]
...
external error : 'a -> unit = "error" [@@bs.val] [@@bs.scope "console"]
external error2 : 'a -> 'b -> unit = "error" [@@bs.val] [@@bs.scope "console"]
