...
eqx("File \"bs_hashmap_test.ml\", line 32, characters 6-13", Belt_HashMap.size(empty), 3);
...
eqx("File \"bs_hashmap_test.ml\", line 41, characters 6-13", Belt_HashMap.size(xx), 91);
...
eqx("File \"bs_hashmap_test.ml\", line 48, characters 6-13", Belt_HashMap.size(v$1), 100001);

for(var i = 0; i <= 1000; ++i){
  Belt_HashMap.remove(v$1, i);
}

eqx("File \"bs_hashmap_test.ml\", line 52, characters 6-13", Belt_HashMap.size(v$1), 99000);

for(var i$1 = 0; i$1 <= 2000; ++i$1){
  Belt_HashMap.remove(v$1, i$1);
}

eqx("File \"bs_hashmap_test.ml\", line 56, characters 6-13", Belt_HashMap.size(v$1), 98000);
