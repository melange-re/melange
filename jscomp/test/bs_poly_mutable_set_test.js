...
var Belt_MutableSet = require("melange/jscomp/others/belt_MutableSet.js");
...
eq("File \"bs_poly_mutable_set_test.ml\", line 22, characters 5-12", Belt_MutableSet.size(u), 28);

var r = Array_data_util.randomRange(0, 30);

b("File \"bs_poly_mutable_set_test.ml\", line 24, characters 4-11", 29 === Belt_MutableSet.maxUndefined(u));

b("File \"bs_poly_mutable_set_test.ml\", line 25, characters 4-11", 1 === Belt_MutableSet.minUndefined(u));
...
eq("File \"bs_poly_mutable_set_test.ml\", line 35, characters 5-12", Belt_MutableSet.size(u), 3);
...
eq("File \"bs_poly_mutable_set_test.ml\", line 43, characters 5-12", Belt_MutableSet.size(u), 20001);

Belt_MutableSet.removeMany(u, Array_data_util.randomRange(0, 200));

eq("File \"bs_poly_mutable_set_test.ml\", line 45, characters 5-12", Belt_MutableSet.size(u), 19800);

Belt_MutableSet.removeMany(u, Array_data_util.randomRange(0, 1000));

eq("File \"bs_poly_mutable_set_test.ml\", line 47, characters 5-12", Belt_MutableSet.size(u), 19000);

Belt_MutableSet.removeMany(u, Array_data_util.randomRange(0, 1000));

eq("File \"bs_poly_mutable_set_test.ml\", line 49, characters 5-12", Belt_MutableSet.size(u), 19000);

Belt_MutableSet.removeMany(u, Array_data_util.randomRange(1000, 10000));

eq("File \"bs_poly_mutable_set_test.ml\", line 51, characters 5-12", Belt_MutableSet.size(u), 10000);

Belt_MutableSet.removeMany(u, Array_data_util.randomRange(10000, 19999));

eq("File \"bs_poly_mutable_set_test.ml\", line 53, characters 5-12", Belt_MutableSet.size(u), 1);
...
eq("File \"bs_poly_mutable_set_test.ml\", line 64, characters 5-12", Belt_MutableSet.size(v), 501);
...
eq("File \"bs_poly_mutable_set_test.ml\", line 68, characters 5-12", Belt_MutableSet.size(v), 1501);

b("File \"bs_poly_mutable_set_test.ml\", line 69, characters 4-11", Belt_MutableSet.isEmpty(Belt_MutableSet.make(IntCmp)));

eq("File \"bs_poly_mutable_set_test.ml\", line 70, characters 5-12", Belt_MutableSet.minimum(v), 500);

eq("File \"bs_poly_mutable_set_test.ml\", line 71, characters 5-12", Belt_MutableSet.maximum(v), 2000);

eq("File \"bs_poly_mutable_set_test.ml\", line 72, characters 5-12", Belt_MutableSet.minUndefined(v), 500);

eq("File \"bs_poly_mutable_set_test.ml\", line 73, characters 5-12", Belt_MutableSet.maxUndefined(v), 2000);

eq("File \"bs_poly_mutable_set_test.ml\", line 74, characters 5-12", Belt_MutableSet.reduce(v, 0, (function (x, y) {
            return x + y | 0;
          })), 1876250);

b("File \"bs_poly_mutable_set_test.ml\", line 75, characters 4-11", Belt_List.eq(Belt_MutableSet.toList(v), Belt_List.makeBy(1501, (function (i) {
                return i + 500 | 0;
              })), (function (x, y) {
            return x === y;
          })));

eq("File \"bs_poly_mutable_set_test.ml\", line 76, characters 5-12", Belt_MutableSet.toArray(v), Array_data_util.range(500, 2000));
...
b("File \"bs_poly_mutable_set_test.ml\", line 82, characters 4-11", Belt_Array.eq(Belt_MutableSet.toArray(aa), Array_data_util.range(500, 999), (function (prim0, prim1) {
            return prim0 === prim1;
          })));

b("File \"bs_poly_mutable_set_test.ml\", line 83, characters 4-11", Belt_Array.eq(Belt_MutableSet.toArray(bb), Array_data_util.range(1001, 2000), (function (prim0, prim1) {
            return prim0 === prim1;
          })));
...
b("File \"bs_poly_mutable_set_test.ml\", line 91, characters 4-11", Belt_Array.eq(Belt_MutableSet.toArray(aa$1), Array_data_util.range(500, 999), (function (prim0, prim1) {
            return prim0 === prim1;
          })));

b("File \"bs_poly_mutable_set_test.ml\", line 92, characters 4-11", Belt_Array.eq(Belt_MutableSet.toArray(bb$1), Array_data_util.range(1001, 2000), (function (prim0, prim1) {
            return prim0 === prim1;
          })));
...
b("File \"bs_poly_mutable_set_test.ml\", line 112, characters 4-11", Belt_MutableSet.eq(Belt_MutableSet.intersect(fromArray(Array_data_util.randomRange(0, 20)), fromArray(Array_data_util.randomRange(21, 40))), Belt_MutableSet.make(IntCmp)));

b("File \"bs_poly_mutable_set_test.ml\", line 118, characters 4-11", Belt_MutableSet.eq(Belt_MutableSet.intersect(fromArray(Array_data_util.randomRange(21, 40)), fromArray(Array_data_util.randomRange(0, 20))), Belt_MutableSet.make(IntCmp)));
