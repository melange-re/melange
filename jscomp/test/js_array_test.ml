...
let suites = Mt.[
    ...
    *)
    ...
    "fillInPlace", (fun _ ->
      Eq([| 4; 4; 4 |],
         [| 1; 2; 3 |] |. Js.Array.fillInPlace ~value:4)
    );
    "fillFromInPlace", (fun _ ->
      Eq([| 1; 4; 4 |],
         [| 1; 2; 3 |] |. Js.Array.fillFromInPlace ~value:4 ~from:1)
    );
    "fillRangeInPlace", (fun _ ->
      Eq([| 1; 4; 3 |],
         [| 1; 2; 3 |] |. Js.Array.fillRangeInPlace ~value:4 ~start:1 ~end_:2)
    );
    ...
    "indexOfFrom", (fun _ ->
      Eq(3, [| 1; 2; 3; 2 |] |. Js.Array.indexOfFrom ~value:2 ~from:2)
    );
    ...
    "lastIndexOfFrom", (fun _ ->
      Eq(1, [| 1; 2; 3; 2 |] |. Js.Array.lastIndexOfFrom ~value:2 ~from:2)
    );
    ...
    "sliceFrom", (fun _ ->
      Eq([| 3; 4; 5 |],
         [| 1; 2; 3; 4; 5 |] |. Js.Array.sliceFrom ~pos:2)
    );
