...
function init_env(token_sinkOpt, parse_optionsOpt, source, content) {
  ...
  if (source !== undefined && !/* tag */ (typeof source !== "object" && typeof source !== "function")) {
    const init = lb.lex_curr_p;
    lb.lex_curr_p = {
      pos_fname: source._0,
      pos_lnum: init.pos_lnum,
...
function unary(env) {
  ...
  if (op !== undefined) {
    ...
    if (op === /* Delete */ 6) {
      let tmp = argument[1];
      if (!/* tag */ (typeof tmp !== "object" && typeof tmp !== "function") && tmp.TAG === /* Identifier */ 18) {
        strict_error_at(env, [
          loc,
          /* StrictDelete */ 32
        ]);
  ...
  if (op$1 === undefined) {
    ...
    if (!/* tag */ (typeof match$2 !== "object" && typeof match$2 !== "function") && match$2.TAG === /* Identifier */ 18) {
  ...
  if (!/* tag */ (typeof match$3 !== "object" && typeof match$3 !== "function") && match$3.TAG === /* Identifier */ 18) {
...
function assignment_but_not_arrow_function(env) {
  ...
  const match = expr[1];
  if (!/* tag */ (typeof match !== "object" && typeof match !== "function") && match.TAG === /* Identifier */ 18) {
  ...
  while (true) {
    ...
    if (module_kind !== undefined) {
      if (module_kind.TAG === /* CommonJS */ 0) {
        if (/* tag */ typeof stmt$1 !== "object" && typeof stmt$1 !== "function") {
      ...
      } else if (/* tag */ typeof stmt$1 !== "object" && typeof stmt$1 !== "function" || stmt$1.TAG !== /* DeclareModuleExports */ 26) {
        module_kind$1 = module_kind;
      } else {
        error$1(env, /* AmbiguousDeclareModuleKind */ 61);
        module_kind$1 = module_kind;
      }
    } else if (/* tag */ typeof stmt$1 !== "object" && typeof stmt$1 !== "function") {
      module_kind$1 = module_kind;
    } else {
      switch (stmt$1.TAG) {
        case /* DeclareModuleExports */ 26 :
    ...
    case /* T_EXPORT */ 47 :
      ...
      switch (exit) {
        ...
        case 2 :
          ...
          const loc$4 = stmt[0];
          let names;
          if (/* tag */ typeof match$8 !== "object" && typeof match$8 !== "function") {
            throw new Caml_js_exceptions.MelangeError("Failure", {
                MEL_EXN_ID: "Failure",
...
function directives(env, term_fn, item_fn) {
  const match = statement_list$1(env, term_fn, item_fn, [
    /* [] */ 0,
    /* [] */ 0
  ]);
  const env$1 = match[0];
  Stdlib__List.iter((function (param) {
    const token = param[1];
    if (!/* tag */ (typeof token !== "object" && typeof token !== "function") && token.TAG === /* T_STRING */ 1) {
      if (token._0[3]) {
...
function statement_list_with_directives(term_fn, env) {
  ...
  const env$1 = match[0];
  const stmts = Curry._2(statement_list, term_fn, env$1);
  ...
  try {
    ...
    const loc = function ($$location) {
      ...
      const source = match !== undefined ? (
          /* tag */ typeof match !== "object" && typeof match !== "function" ? string("(global)") : string(match._0)
        ) : $$null;
      return obj([
        [
          "source",
    ...
    const expression = function (param) {
      const arr = param[1];
      const loc = param[0];
      if (/* tag */ typeof arr !== "object" && typeof arr !== "function") {
    ...
    const literal = function (param) {
      ...
      let props;
      let exit = 0;
      if (/* tag */ typeof value !== "object" && typeof value !== "function" || value.TAG !== /* RegExp */ 3) {
        exit = 1;
      } else {
