...
const array_suites_0 = [
  "check_array_bound_valid",
  (function (param) {
    Caml_array.check_bound(2, 1);
    return {
      TAG: /* Eq */ 0,
      _0: undefined,
      _1: undefined
...
const array_suites_1 = {
  ...
  tl: {
    hd: [
      "check_array_bound_length",
      (function (param) {
        return {
          TAG: /* ThrowAny */ 7,
          _0: (function (param) {
            Caml_array.check_bound(2, 2);
          })
        };
      })
    ],
            ...
            tl: {
              ...
              tl: {
                ...
                tl: {
                  ...
                  tl: {
                    hd: [
                      "File \"jscomp/test/array_test.ml\", line 80, characters 2-9",
                      (function (param) {
                        const a0 = Stdlib__Array.init(100, (function (i) {
                          return (i << 0);
                        }));
