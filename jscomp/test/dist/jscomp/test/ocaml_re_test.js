...
function compare(param, param$1) {
  let c = Caml_obj.caml_compare(param[0], param$1[0]);
  if (c !== 0) {
    return c;
  } else {
...
let Table = Stdlib__Hashtbl.Make({
      equal: equal$1,
      hash: hash$3
    });
...
function delta_1(marks, c, next_cat, prev_cat, x, rem) {
  ...
  switch (s.TAG | 0) {
    ...
    case /* Rep */3 :
        ...
        let marks$p = first((function (param) {
                switch (param.TAG | 0) {
                  case /* TSeq */0 :
                  case /* TExp */1 :
                      return ;
    ...
    case /* Pmark */8 :
        ...
        let marks_pmarks$1 = Curry._2(add$1, s._0, marks.pmarks);
        let marks$2 = {
          marks: marks_marks$1,
...
function delta_seq(c, next_cat, prev_cat, kind, y, z, rem) {
  let marks = first((function (param) {
          switch (param.TAG | 0) {
            case /* TSeq */0 :
            case /* TExp */1 :
                return ;
...
function flatten_match(m) {
  let ma = Stdlib__List.fold_left((function (ma, param) {
...
function mk_state(ncol, desc) {
  ...
  let break_state = typeof match === "number" && match ? false : true;
  return {
...
function trans_set(cache, cm, s) {
  ...
  try {
    ...
    let exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
    if (exn.MEL_EXN_ID === Stdlib.Not_found) {
      let l = Stdlib__List.fold_right((function (param, l) {
...
let calpha = Stdlib__List.fold_right(cadd, {
      hd: /* '\170' */170,
      tl: {
        hd: /* '\181' */181,
        tl: {
...
function flatten_cmap(cm) {
  let c = Caml_bytes.caml_create_bytes(256);
  let col_repr = Caml_bytes.caml_create_bytes(256);
  let v = 0;
  ...
  while(true) {
    ...
    if (typeof param === "number") {
      ...
      switch (param.TAG | 0) {
        case /* Set */0 :
            return [
                    cst(ids, trans_set(cache, c, param._0)),
                    kind
                  ];
        case /* Sequence */1 :
            return [
                    trans_seq(ids, kind, ign_group, ign_case, greedy, pos, cache, c, param._0),
                    kind
                  ];
        case /* Alternative */2 :
            let merged_sequences = merge_sequences(param._0);
        ...
        case /* Repeat */3 :
            let j = param._2;
            let i = param._1;
            let match$1 = translate(ids, kind, ign_group, ign_case, greedy, pos, cache, c, param._0);
        ...
        case /* Sem */4 :
            let kind$p$1 = param._0;
            let match$2 = translate(ids, kind$p$1, ign_group, ign_case, greedy, pos, cache, c, param._1);
            return [
        ...
        case /* Nest */8 :
            let b = pos.contents;
            let match$4 = translate(ids, kind, ign_group, ign_case, greedy, pos, cache, c, param._0);
        ...
        case /* Pmark */14 :
            let match$5 = translate(ids, kind, ign_group, ign_case, greedy, pos, cache, c, param._1);
            return [
                    seq$1(ids, "First", mk_expr(ids, {
                              TAG: /* Pmark */8,
                              _0: param._0
...
function trans_seq(ids, kind, ign_group, ign_case, greedy, pos, cache, c, param) {
  ...
  if (param.tl) {
    ...
    let cr$p = match[0];
    let cr$p$p = trans_seq(ids, kind, ign_group, ign_case, greedy, pos, cache, c, param.tl);
    if (is_eps(cr$p$p)) {
      return cr$p;
    } else if (is_eps(cr$p)) {
      return cr$p$p;
...
function handle_case(_ign_case, _r) {
  while(true) {
    ...
    switch (r.TAG | 0) {
      ...
      case /* Alternative */2 :
          let l$p = Stdlib__List.map((function(ign_case){
              return function (param) {
                return handle_case(ign_case, param);
              }
              }(ign_case)), r._0);
      ...
      case /* Repeat */3 :
          return {
                  TAG: /* Repeat */3,
                  _0: handle_case(ign_case, r._0),
                  _1: r._1,
                  _2: r._2
                };
      case /* Sem */4 :
          let r$p = handle_case(ign_case, r._1);
          if (is_charset(r$p)) {
            return r$p;
          } else {
            return {
      ...
      case /* Sem_greedy */5 :
          let r$p$1 = handle_case(ign_case, r._1);
          if (is_charset(r$p$1)) {
            return r$p$1;
          } else {
            return {
      ...
      case /* No_group */7 :
          let r$p$2 = handle_case(ign_case, r._0);
          if (is_charset(r$p$2)) {
            return r$p$2;
          } else {
            return {
      ...
      case /* Nest */8 :
          let r$p$3 = handle_case(ign_case, r._0);
          if (is_charset(r$p$3)) {
            return r$p$3;
          } else {
            return {
      ...
      case /* No_case */10 :
          ...
          continue ;
      case /* Intersection */11 :
          let l$p$1 = Stdlib__List.map((function(ign_case){
              return function (r) {
      ...
      case /* Complement */12 :
          let l$p$2 = Stdlib__List.map((function(ign_case){
              return function (r) {
                return handle_case(ign_case, r);
              }
              }(ign_case)), r._0);
      ...
      case /* Difference */13 :
          return {
                  TAG: /* Set */0,
                  _0: inter(as_set(handle_case(ign_case, r._0)), diff(cany, as_set(handle_case(ign_case, r._1))))
                };
      case /* Pmark */14 :
          return {
                  TAG: /* Pmark */14,
                  _0: r._0,
                  _1: handle_case(ign_case, r._1)
                };
...
function anchored(_param) {
  while(true) {
    ...
    if (typeof param === "number") {
      ...
      switch (param.TAG | 0) {
        case /* Sequence */1 :
            return Stdlib__List.exists(anchored, param._0);
        case /* Alternative */2 :
            return Stdlib__List.for_all(anchored, param._0);
        case /* Repeat */3 :
            if (param._1 <= 0) {
              return false;
            }
...
function compile(r) {
  ...
  let c = Stdlib__Bytes.make(257, /* '\000' */0);
...
function re(flagsOpt, pat) {
  ...
  let opts = Stdlib__List.map((function (param) {
          if (param === "CASELESS") {
            return "Caseless";
  ...
  let r = parse(Stdlib__List.memq("Multiline", opts$1), Stdlib__List.memq("Dollar_endonly", opts$1), Stdlib__List.memq("Dotall", opts$1), Stdlib__List.memq("Ungreedy", opts$1), pat);
  let r$1 = Stdlib__List.memq("Anchored", opts$1) ? seq$2({
          hd: /* Start */8,
          tl: {
            hd: r,
            tl: /* [] */0
...
let s = Caml_bytes.bytes_to_string(Stdlib__Bytes.make(1048575, /* 'a' */97)) + "b";
