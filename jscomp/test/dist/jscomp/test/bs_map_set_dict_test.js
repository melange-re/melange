...
let Icmp2 = Belt__Belt_Id.comparable(Caml.caml_int_compare);

let Ic3 = Belt__Belt_Id.comparable(Caml.caml_int_compare);
...
let I2 = Belt__Belt_Id.comparable(function (x, y) {
...
let m_dict = Belt__Belt_Map.getId(m);
...
let m11 = Belt__Belt_MapDict.set(undefined, 1, 1, Icmp.cmp);

console.log(m11);

let m_dict$1 = Belt__Belt_Map.getId(m);
...
let u0 = f(Belt__Belt_Array.map(Array_data_util.randomRange(0, 39), (function (x) {
            return [
                    x,
                    x
                  ];
...
let u1 = Belt__Belt_Map.set(u0, 39, 120);
...
let u = f(Belt__Belt_Array.makeByAndShuffle(10000, (function (x) {
            return [
                    x,
                    x
                  ];
