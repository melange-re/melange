...
var Icmp2 = Belt__Belt_Id.comparable(Caml.caml_int_compare);

var Ic3 = Belt__Belt_Id.comparable(Caml.caml_int_compare);
...
var I2 = Belt__Belt_Id.comparable(function (x, y) {
...
var m_dict = Belt__Belt_Map.getId(m);
...
var m11 = Belt__Belt_MapDict.set(undefined, 1, 1, Icmp.cmp);

console.log(m11);

var m_dict$1 = Belt__Belt_Map.getId(m);
...
var u0 = f(Belt__Belt_Array.map(Array_data_util.randomRange(0, 39), (function (x) {
            return [
                    x,
                    x
                  ];
