...
let Belt__Belt_HashMap = require("melange.belt/belt_HashMap.js");
let Belt__Belt_HashMapInt = require("melange.belt/belt_HashMapInt.js");
let Belt__Belt_HashMapString = require("melange.belt/belt_HashMapString.js");
...
let Caml_hash_primitive = require("melange.js/caml_hash_primitive.js");
...
let $$String = Belt__Belt_Id.hashable(Stdlib__Hashtbl.hash, (function (x, y) {
        return x === y;
      }));

let String1 = Belt__Belt_Id.hashable(hashString, (function (x, y) {
        return x === y;
      }));

let String2 = Belt__Belt_Id.hashable((function (x) {
        return Caml_hash_primitive.caml_hash_final_mix(Caml_hash_primitive.caml_hash_mix_string(0, x));
      }), (function (x, y) {
        return x === y;
      }));

let Int = Belt__Belt_Id.hashable(Stdlib__Hashtbl.hash, (function (x, y) {
        return x === y;
      }));

let empty = Belt__Belt_internalBucketsType.make(Int.hash, Int.eq, 500000);
...
function bench2(m) {
  let empty = Belt__Belt_internalBucketsType.make(m.hash, m.eq, 1000000);
  for(let i = 0; i <= 1000000; ++i){
...
let Sx = Belt__Belt_Id.comparable(Caml.caml_string_compare);

function bench4(param) {
  let table = Belt__Belt_internalBucketsType.make(undefined, undefined, 1000000);
  for(let i = 0; i <= 1000000; ++i){
...
function bench5(param) {
  let table = Belt__Belt_internalBucketsType.make(Int.hash, Int.eq, 1000000);
...
function bench7(param) {
  let table = Belt__Belt_internalBucketsType.make(undefined, undefined, 2000000);
  for(let i = 0; i <= 1000000; ++i){
