...
function string_of_field_type(param) {
  if (typeof param === "number") {
    ...
    var module_ = param$1.udt_module;
...
function compile_message_p1(file_name, file_options, message_scope, param) {
  ...
  var match = Stdlib__List.fold_left((function (param, param$1) {
          ...
          switch (param$1.TAG | 0) {
            ...
            case /* Message_sub */3 :
                var all_sub_types = compile_message_p1(file_name, file_options, sub_scope, param$1._0);
                return [
                        message_body,
                        extensions,
...
function gen_encode_field_key(sc, number, pk, is_packed) {
  ...
  var s$1 = Caml_bytes.bytes_to_string(Stdlib__Bytes.lowercase_ascii(Caml_bytes.bytes_of_string(s)));
  line$1(sc, Curry._2(Stdlib__Printf.sprintf(/* Format */{
                _0: {
                  TAG: /* String_literal */11,
                  _0: "Pbrt.Encoder.key (",
...
function constructor_name(s) {
  ...
  var s$2 = Caml_bytes.bytes_to_string(Stdlib__Bytes.lowercase_ascii(Caml_bytes.bytes_of_string(s$1)));
...
function compile(proto_definition) {
  ...
  try {
    ...
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
    throw new Caml_js_exceptions.MelangeError(add_loc(from_lexbuf(lexbuf), exn).MEL_EXN_ID, {
