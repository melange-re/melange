...
var glo = Stdlib__Bytes.make(4096, /* '\000' */0);
...
var obuf = Stdlib__Bytes.make(1048576, /* '\000' */0);
...
function binary(stk, lvl) {
  ...
  if (lvl < 8) {
    ...
    while(true) {
      ...
      binary(stk, lvl - 1 | 0);
      pop(1);
      var ops = Stdlib__List.assoc(o$1, inss);
      if (ops.TAG === /* Bin */0) {
        ...
        switch (o) {
          ...
          default:
            ...
            if (!Stdlib__List.mem_assoc(o, unops)) {
              Stdlib.failwith(Curry._1(Stdlib__Printf.sprintf(/* Format */{
                            _0: {
                              TAG: /* String_literal */11,
                              _0: "unknown operator ",
                              _1: {
...
var elfhdr = Stdlib__Bytes.of_string(Stdlib__String.concat("", {
