...
let cmp = Caml.caml_int_compare;

let Y = Belt__Belt_Id.hashable(hash, eq);

let empty = Belt__Belt_internalBucketsType.make(Y.hash, Y.eq, 30);
...
let v = Belt__Belt_Array.zip(u, u);

let xx = Belt__Belt_HashMap.fromArray(v, Y);
...
let v$1 = Belt__Belt_internalBucketsType.make(Y.hash, Y.eq, 40);
