...
function absolute_path(s) {
  var s$1 = Curry._1(Stdlib__Filename.is_relative, s) ? Stdlib__Filename.concat(CamlinternalLazy.force(cwd), s) : s;
  var aux = function (_s) {
    while(true) {
      var s = _s;
...
var os_path_separator_char = Stdlib__Filename.dir_sep.charCodeAt(0);

function relative_path(file_or_dir_1, file_or_dir_2) {
  var relevant_dir1 = file_or_dir_1.NAME === "File" ? Curry._1(Stdlib__Filename.dirname, file_or_dir_1.VAL) : file_or_dir_1.VAL;
  var relevant_dir2 = file_or_dir_2.NAME === "File" ? Curry._1(Stdlib__Filename.dirname, file_or_dir_2.VAL) : file_or_dir_2.VAL;
...
function split_aux(p) {
  ...
  while(true) {
    var acc = _acc;
    var p$1 = _p;
    var dir = Curry._1(Stdlib__Filename.dirname, p$1);
    if (dir === p$1) {
      return [
              dir,
              acc
    ...
    var new_path = Curry._1(Stdlib__Filename.basename, p$1);
...
function rel_normalized_absolute_path(from, to_) {
  ...
  while(true) {
    ...
    var start = Stdlib__List.fold_left((function (acc, param) {
            return Stdlib__Filename.concat(acc, Ext_string_test.parent_dir_lit);
          }), Ext_string_test.parent_dir_lit, xs);
