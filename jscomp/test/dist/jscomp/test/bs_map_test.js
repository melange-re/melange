...
let mapOfArray = Belt__Belt_MapInt.fromArray;

let setOfArray = Belt__Belt_SetInt.fromArray;

function emptyMap(param) {
  
}

let v = Belt__Belt_Array.makeByAndShuffle(1000000, (function (i) {
        return [
                i,
                i
              ];
...
let u = Belt__Belt_MapInt.fromArray(v);

Belt__Belt_MapInt.checkInvariantInternal(u);

let firstHalf = Belt__Belt_Array.slice(v, 0, 2000);

let xx = Belt__Belt_Array.reduce(firstHalf, u, (function (acc, param) {
