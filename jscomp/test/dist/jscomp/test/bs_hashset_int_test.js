...
var v = Belt__Belt_HashSetInt.fromArray(u);

eq("File \"bs_hashset_int_test.ml\", line 19, characters 5-12", v.size, 91);

var xs = Belt__Belt_SetInt.toArray(Belt__Belt_SetInt.fromArray(Belt__Belt_HashSetInt.toArray(v)));

eq("File \"bs_hashset_int_test.ml\", line 21, characters 5-12", xs, Array_data_util.range(30, 120));

eq("File \"bs_hashset_int_test.ml\", line 23, characters 5-12", Belt__Belt_HashSetInt.reduce(v, 0, add), 6825);
...
var v$1 = Belt__Belt_internalBucketsType.make(undefined, undefined, 40);
...
var u0 = Belt__Belt_HashSetInt.fromArray(Array_data_util.randomRange(0, 100000));

var u1 = Belt__Belt_HashSetInt.copy(u0);

eq("File \"bs_hashset_int_test.ml\", line 46, characters 5-12", Belt__Belt_HashSetInt.toArray(u0), Belt__Belt_HashSetInt.toArray(u1));
...
var v0 = Belt__Belt_Array.concat(Array_data_util.range(0, 1000), Belt__Belt_HashSetInt.toArray(u0));

var v1 = Belt__Belt_Array.concat(Array_data_util.range(0, 2000), Belt__Belt_HashSetInt.toArray(u1));
...
var h = Belt__Belt_HashSetInt.fromArray(Array_data_util.randomRange(0, 1000000));

var histo = Belt__Belt_HashSetInt.getBucketHistogram(h);
