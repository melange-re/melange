...
let Belt__Belt_HashSetInt = require("melange.belt/belt_HashSetInt.js");
let Belt__Belt_SetInt = require("melange.belt/belt_SetInt.js");
let Belt__Belt_SortArrayInt = require("melange.belt/belt_SortArrayInt.js");
let Belt__Belt_internalBucketsType = require("melange.belt/belt_internalBucketsType.js");
...
let u = Belt__Belt_Array.concat(Array_data_util.randomRange(30, 100), Array_data_util.randomRange(40, 120));

let v = Belt__Belt_HashSetInt.fromArray(u);

eq("File \"jscomp/test/bs_hashset_int_test.ml\", line 19, characters 5-12", v.size, 91);

let xs = Belt__Belt_SetInt.toArray(Belt__Belt_SetInt.fromArray(Belt__Belt_HashSetInt.toArray(v)));
...
let u$1 = Belt__Belt_Array.concat(Array_data_util.randomRange(0, 100000), Array_data_util.randomRange(0, 100));

let v$1 = Belt__Belt_internalBucketsType.make(undefined, undefined, 40);
...
let u0 = Belt__Belt_HashSetInt.fromArray(Array_data_util.randomRange(0, 100000));

let u1 = Belt__Belt_HashSetInt.copy(u0);
...
let v0 = Belt__Belt_Array.concat(Array_data_util.range(0, 1000), Belt__Belt_HashSetInt.toArray(u0));

let v1 = Belt__Belt_Array.concat(Array_data_util.range(0, 2000), Belt__Belt_HashSetInt.toArray(u1));
...
let h = Belt__Belt_HashSetInt.fromArray(Array_data_util.randomRange(0, 1000000));

let histo = Belt__Belt_HashSetInt.getBucketHistogram(h);
...
let $plus$plus = Belt__Belt_Array.concat;
