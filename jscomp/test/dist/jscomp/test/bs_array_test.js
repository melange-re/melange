...
let v$5 = Belt__Belt_Array.makeBy(3000, (function (i) {
        return i;
      }));

let u = Belt__Belt_Array.shuffle(v$5);
...
let v$6 = Belt__Belt_Array.makeBy(10, (function (i) {
        return i;
      }));

let v0 = Belt__Belt_Array.keep(v$6, (function (x) {
        return x % 2 === 0;
      }));

let v1 = Belt__Belt_Array.keep(v$6, (function (x) {
        return x % 3 === 0;
      }));

let v2 = Belt__Belt_Array.keepMap(v$6, (function (x) {
        if (x % 2 === 0) {
          return x + 1 | 0;
        }
...
let match = Belt__Belt_Array.partition(a, (function (x) {
        return x % 2 === 0;
      }));
...
let match$1 = Belt__Belt_Array.partition(a, (function (x) {
        return x === 2;
      }));
...
let match$2 = Belt__Belt_Array.partition([], (function (x) {
        return false;
      }));
...
let a$3 = Belt__Belt_Array.makeBy(10, (function (x) {
        return x;
      }));
...
let a0 = Belt__Belt_Array.makeBy(10, (function (x) {
        return x;
      }));

let b0 = Belt__Belt_Array.make(10, 3);
...
let aa = Belt__Belt_Array.makeBy(10, (function (x) {
        return x;
      }));
...
function every2(xs, ys) {
  let partial_arg = Belt__Belt_List.toArray(ys);
  let partial_arg$1 = Belt__Belt_List.toArray(xs);
