...
let p = Curry._2(point[0], undefined, 3);

let q = Curry._3(colored_point[0], undefined, 4, "blue");
...
function c_init($$class) {
  let m = CamlinternalOO.get_method_label($$class, "m");
...
let c = CamlinternalOO.make_class(shared$1, c_init);
...
function d_init($$class) {
  ...
  let n = ids[0];
  let as_c = ids[2];
  let inh = CamlinternalOO.inherits($$class, 0, 0, shared$1, c, true);
  let obj_init = inh[0];
  CamlinternalOO.set_methods($$class, [
        n,
        (function (self$4) {
...
let table = CamlinternalOO.create_table([
      "as_c",
      "m",
      "n"
    ]);

let env_init = d_init(table);

CamlinternalOO.init_class(table);

let d_0 = Curry._1(env_init, undefined);
...
function functional_point_init($$class) {
  ...
  CamlinternalOO.set_methods($$class, [
        ...
        move,
        (function (self$6, d) {
            let copy = Caml_oo.caml_set_oo_id(Caml_obj.caml_obj_dup(self$6));
            copy[x] = self$6[x] + d | 0;
            return copy;
          })
      ]);
...
let functional_point = CamlinternalOO.make_class(shared, functional_point_init);

let p$1 = Curry._2(functional_point[0], undefined, 7);

let tmp = Caml_oo_curry.js2(-933174511, 2, p$1, 3);
...
let table$1 = CamlinternalOO.create_table(shared);

let env_init$1 = bad_functional_point_init(table$1);

CamlinternalOO.init_class(table$1);

let bad_functional_point_0 = Curry._1(env_init$1, undefined);

let bad_functional_point = [
...
let p$2 = Curry._2(bad_functional_point_0, undefined, 7);

let tmp$1 = Caml_oo_curry.js2(-933174511, 6, p$2, 3);
