...
function generate_coins(_block_coord) {
  while(true) {
    ...
    var place_coin = Stdlib__Random.$$int(2);
    if (!block_coord) {
      return /* [] */0;
    }
...
function choose_block_pattern(blockw, blockh, cbx, cby, prob) {
  ...
  var block_typ = Stdlib__Random.$$int(4);
  var stair_typ = Stdlib__Random.$$int(2);
  var life_block_chance = Stdlib__Random.$$int(5);
  ...
  switch (prob) {
    ...
    case 1 :
        var num_clouds = Stdlib__Random.$$int(5) + 5 | 0;
        if (cby < 5) {
...
function generate_enemies(blockw, blockh, _cbx, _cby, acc) {
  while(true) {
    ...
    var prob = Stdlib__Random.$$int(30);
...
function generate_block_enemies(_block_coord) {
  while(true) {
    var block_coord = _block_coord;
    var place_enemy = Stdlib__Random.$$int(20);
    var enemy_typ = Stdlib__Random.$$int(3);
    if (!block_coord) {
      return /* [] */0;
    }
    var t = block_coord.tl;
...
function generate_block_locs(blockw, blockh, _cbx, _cby, _acc) {
  while(true) {
    ...
    var prob = Stdlib__Random.$$int(100);
    if (prob < 5) {
...
function generate_ground(blockw, blockh, _inc, _acc) {
  while(true) {
    ...
    if (inc > 10) {
      var skip = Stdlib__Random.$$int(10);
...
function load(param) {
  ...
  var canvas = el !== null ? el : (Curry._1(Stdlib__Printf.printf(/* Format */{
                _0: {
