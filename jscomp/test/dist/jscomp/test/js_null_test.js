...
var Js__Js_null = require("melange.js/js_null.js");
          ...
          hd: [
            ...
            (function (param) {
                return {
                        TAG: /* StrictEq */2,
                        _0: null,
                        _1: Js__Js_null.bind(null, (function (v) {
                                return v;
                              }))
                      };
              })
            ...
            hd: [
              ...
              (function (param) {
                  return {
                          TAG: /* StrictEq */2,
                          _0: 4,
                          _1: Js__Js_null.bind(2, (function (n) {
                                  return (n << 1);
                                }))
                        };
                })
            ...
            tl: {
              hd: [
                ...
                (function (param) {
                    ...
                    Js__Js_null.iter(null, (function (param) {
                            hit.contents = true;
                          }));
                    return {
                            TAG: /* Eq */0,
