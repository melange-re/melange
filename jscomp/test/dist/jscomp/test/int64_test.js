...
let v = Caml_int64.add(Caml_int64.of_int32(Stdlib__Int32.max_int), Stdlib__Int64.one);
...
let shift_left_tests_0 = Stdlib__Array.map((function (i) {
...
let shift_right_tests_0 = Stdlib__Array.map((function (i) {
...
let shift_right_logical_suites_0 = Stdlib__Array.map((function (i) {
...
function id(loc, x) {
  ...
  let match = Stdlib.classify_float(float_value);
  if (match >= 4) {
    return ;
  } else {
