...
let Js__Js_json = require("melange.js/js_json.js");
...
add_test("File \"jscomp/test/js_json_test.ml\", line 24, characters 11-18", (function (param) {
        ...
        let v$1 = Js__Js_dict.get(ty._0, "x");
        if (v$1 === undefined) {
          return {
                  TAG: /* Ok */4,
                  _0: false
        ...
        let ty2 = Js__Js_json.classify(Caml_option.valFromOption(v$1));
        ...
        ty2._0.forEach(function (x) {
              let ty3 = Js__Js_json.classify(x);
...
let ty = Js__Js_json.classify(json);
...
let ty$1 = Js__Js_json.classify(json$1);
...
let ty$2 = Js__Js_json.classify(json$2);
...
let ty$3 = Js__Js_json.classify(json$3);
...
let ty$4 = Js__Js_json.classify(json$4);
...
if (typeof ty$4 === "number") {
  ...
  let x = ty$4._0;
  let ta = Js__Js_json.classify(option_get(Js__Js_dict.get(x, "a")));
  if (typeof ta === "number") {
    ...
    if (ta._0 !== "test string") {
      ...
      let ty$5 = Js__Js_json.classify(option_get(Js__Js_dict.get(x, "b")));
...
function eq_at_i(loc, json, i, kind, expected) {
  ...
  let ty$1 = Js__Js_json.classify(Caml_array.get(ty._0, i));
  switch (kind) {
    case /* String */0 :
        if (typeof ty$1 === "number") {
          return add_test(loc, (function (param) {
...
let json$5 = JSON.parse(JSON.stringify(Stdlib__Array.map((function (prim) {
                return prim;
              }), [
              "string 0",
              "string 1",
...
let json$8 = JSON.parse(JSON.stringify(Stdlib__Array.map((function (prim) {
                return prim;
              }), a$1)));
...
let ty$6 = Js__Js_json.classify(json$10);
...
if (typeof ty$6 === "number") {
  ...
  let ty$7 = Js__Js_json.classify(Caml_array.get(ty$6._0, 1));
  if (typeof ty$7 === "number") {
    ...
    let ty$8 = Js__Js_json.classify(option_get(Js__Js_dict.get(ty$7._0, "a")));
