...
add_test("File \"jscomp/test/js_json_test.ml\", line 24, characters 11-18", (function (param) {
  ...
  if (typeof ty2 !== "object" && typeof ty2 !== "function") {
    return {
      TAG: /* Ok */ 4,
      _0: false
    };
  ...
  ty2._0.forEach(function (x) {
    ...
    if (typeof ty3 !== "object" && typeof ty3 !== "function") {
...
if (typeof ty$2 !== "object" && typeof ty$2 !== "function" || ty$2.TAG !== /* JSONNumber */ 1) {
  exit = 1;
} else {
...
if (typeof ty$3 !== "object" && typeof ty$3 !== "function" || ty$3.TAG !== /* JSONNumber */ 1) {
  exit$1 = 1;
} else {
...
if (typeof ty$4 !== "object" && typeof ty$4 !== "function") {
  ...
  if (typeof ta !== "object" && typeof ta !== "function") {
    ...
    if (ta._0 !== "test string") {
      ...
      if (typeof ty$5 !== "object" && typeof ty$5 !== "function") {
...
if (typeof ty$6 !== "object" && typeof ty$6 !== "function") {
  ...
  if (typeof ty$7 !== "object" && typeof ty$7 !== "function") {
    ...
    if (typeof ty$8 !== "object" && typeof ty$8 !== "function") {
