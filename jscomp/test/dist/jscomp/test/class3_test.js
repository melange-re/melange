...
function point_init($$class) {
  let ids = CamlinternalOO.new_methods_variables($$class, shared, shared$8);
  let move = ids[0];
  let get_x = ids[1];
  let x = ids[2];
...
let p = Curry._2(point[0], undefined, 7);
...
function adjusted_point_init($$class) {
  let origin = CamlinternalOO.new_variable($$class, "");
  let ids = CamlinternalOO.new_methods_variables($$class, shared$3, shared$8);
  let move = ids[0];
  let get_x = ids[1];
  ...
  return function (env, self, x_init) {
    let origin$1 = Math.imul(x_init / 10 | 0, 10);
    let self$1 = CamlinternalOO.create_object_opt(self, $$class);
...
let adjusted_point = CamlinternalOO.make_class(shared$5, adjusted_point_init);

let tmp = Curry._2(adjusted_point[0], undefined, 31);
...
function adjusted_point2_1(table) {
  let env_init = Curry._1(point[1], table);
  return function (envs) {
    let partial_arg = Curry._1(env_init, envs);
...
let adjusted_point2_2 = point[2];

let adjusted_point2_3 = point[3];
...
let tmp$1 = Curry._2(adjusted_point2_0, undefined, 31);
...
function printable_point_init($$class) {
  let ids = CamlinternalOO.new_methods_variables($$class, shared$9, shared$8);
  let print = ids[0];
  let move = ids[1];
  let get_x = ids[2];
  let x = ids[3];
...
let p$1 = Curry._2(printable_point[0], undefined, 7);
...
let my_int = CamlinternalOO.create_object_opt(undefined, $$class);
...
function printable_point2_init($$class) {
  ...
  return function (env, self, x_init) {
    let origin = Math.imul(x_init / 10 | 0, 10);
    let self$1 = CamlinternalOO.create_object_opt(self, $$class);
    self$1[x] = origin;
...
function abstract_point_1($$class) {
  ...
  let ids = CamlinternalOO.get_method_labels($$class, shared$3);
  let get_x = ids[1];
  let get_offset = ids[2];
...
function vpoint_init($$class) {
  ...
  let get_x = ids[1];
  let x = ids[3];
  let inh = CamlinternalOO.inherits($$class, 0, shared, ["get_offset"], abstract_point, true);
  let obj_init = inh[0];
  CamlinternalOO.set_methods($$class, [
        get_x,
        (function (self$8) {
...
let vpoint = CamlinternalOO.make_class(shared$5, vpoint_init);

let h = Curry._2(vpoint[0], undefined, 3);

Caml_oo_curry.js2(-933174511, 8, h, 32);

let v$1 = Caml_oo_curry.js1(-792262820, 9, h);

eq("File \"jscomp/test/class3_test.ml\", line 107, characters 12-19", v$1, 32);

function abstract_point2_1($$class) {
  let ids = CamlinternalOO.new_methods_variables($$class, shared$2, shared$8);
  let move = ids[0];
  let x = ids[1];
...
function point2_init($$class) {
  let x_init = CamlinternalOO.new_variable($$class, "");
  let ids = CamlinternalOO.get_method_labels($$class, shared$4);
  let get_offset = ids[1];
  let inh = CamlinternalOO.inherits($$class, shared$8, 0, shared$2, abstract_point2, true);
  let obj_init = inh[0];
  let x = inh[1];
...
let point2 = CamlinternalOO.make_class(shared$4, point2_init);

let h$1 = Curry._2(point2[0], undefined, 3);

Caml_oo_curry.js2(-933174511, 10, h$1, 32);

let vv = Caml_oo_curry.js1(-792262820, 11, h$1);

eq("File \"jscomp/test/class3_test.ml\", line 128, characters 12-19", vv, 32);

function restricted_point_init($$class) {
  let ids = CamlinternalOO.new_methods_variables($$class, shared$11, shared$8);
  let move = ids[0];
  let get_x = ids[1];
  let bump = ids[2];
  let x = ids[3];
...
let restricted_point = CamlinternalOO.make_class([
      "bump",
      "get_x"
    ], restricted_point_init);

let p$2 = Curry._2(restricted_point[0], undefined, 0);

Caml_oo_curry.js1(-1054863370, 12, p$2);

let h$2 = Caml_oo_curry.js1(291546447, 13, p$2);
...
function point_again_init($$class) {
  ...
  let inh = CamlinternalOO.inherits($$class, shared$8, 0, shared$7, restricted_point, true);
  let obj_init = inh[0];
...
let point_again = CamlinternalOO.make_class(shared$6, point_again_init);

let p$3 = Curry._2(point_again[0], undefined, 3);
...
let hh = Caml_oo_curry.js1(291546447, 17, p$3);
...
let point_again2 = CamlinternalOO.make_class(shared$6, point_again2_init);

let p$4 = Curry._2(point_again2[0], undefined, 3);
...
let point_again3 = CamlinternalOO.make_class(shared$6, point_again3_init);

let p$5 = Curry._2(point_again3[0], undefined, 3);
...
let hhhh = Caml_oo_curry.js1(291546447, 25, p$5);
