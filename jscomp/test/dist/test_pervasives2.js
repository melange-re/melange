...
const List = {
  ...
  filter_mapi: Stdlib__List.filter_mapi,
  ...
  split_map: Stdlib__List.split_map,
  ...
  Exit$extension: Stdlib.Exit$extension,
  Match_failure$extension: Stdlib.Match_failure$extension,
  Assert_failure$extension: Stdlib.Assert_failure$extension,
  Invalid_argument$extension: Stdlib.Invalid_argument$extension,
  Failure$extension: Stdlib.Failure$extension,
  Not_found$extension: Stdlib.Not_found$extension,
  Out_of_memory$extension: Stdlib.Out_of_memory$extension,
  Stack_overflow$extension: Stdlib.Stack_overflow$extension,
  Sys_error$extension: Stdlib.Sys_error$extension,
  End_of_file$extension: Stdlib.End_of_file$extension,
  Division_by_zero$extension: Stdlib.Division_by_zero$extension,
  Sys_blocked_io$extension: Stdlib.Sys_blocked_io$extension,
  Undefined_recursive_module$extension: Stdlib.Undefined_recursive_module$extension,
  abs: Stdlib.abs,
  ...
  Exit: Stdlib.Exit$extension,
  Match_failure: Stdlib.Match_failure$extension,
  Assert_failure: Stdlib.Assert_failure$extension,
  Invalid_argument: Stdlib.Invalid_argument$extension,
  Failure: Stdlib.Failure$extension,
  Not_found: Stdlib.Not_found$extension,
  Out_of_memory: Stdlib.Out_of_memory$extension,
  Stack_overflow: Stdlib.Stack_overflow$extension,
  Sys_error: Stdlib.Sys_error$extension,
  End_of_file: Stdlib.End_of_file$extension,
  Division_by_zero: Stdlib.Division_by_zero$extension,
  Sys_blocked_io: Stdlib.Sys_blocked_io$extension,
  Undefined_recursive_module: Stdlib.Undefined_recursive_module$extension
};
