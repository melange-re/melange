...
const CamlinternalFormatBasics = require("./camlinternalFormatBasics.js");
...
function param_format_of_ignored_format(ign, fmt) {
  if (typeof ign !== "object" && typeof ign !== "function") {
    switch (ign) {
      case /* Ignored_char */ 0 :
        return {
...
function bprint_padding(buf, pad) {
  if (typeof pad !== "object" && typeof pad !== "function") {
    return;
  }
...
function bprint_precision(buf, prec) {
  if (typeof prec !== "object" && typeof prec !== "function") {
...
function string_of_formatting_lit(formatting_lit) {
  if (typeof formatting_lit !== "object" && typeof formatting_lit !== "function") {
...
function bprint_fmtty(buf, _fmtty) {
  while (true) {
    const fmtty = _fmtty;
    if (typeof fmtty !== "object" && typeof fmtty !== "function") {
      return;
    }
    switch (fmtty.TAG) {
      case /* Char_ty */ 0 :
...
function bprint_fmt(buf, fmt) {
  ...
  while (true) {
    ...
    const fmt$1 = _fmt;
    if (typeof fmt$1 !== "object" && typeof fmt$1 !== "function") {
      return;
    }
    switch (fmt$1.TAG) {
      case /* Char */ 0 :
...
function symm(rest) {
  if (typeof rest !== "object" && typeof rest !== "function") {
...
function trans(ty1, ty2) {
  let exit = 0;
  if (typeof ty1 !== "object" && typeof ty1 !== "function") {
...
function fmtty_of_custom(arity, fmtty) {
  if (typeof arity !== "object" && typeof arity !== "function") {
    return fmtty;
  } else {
    return {
      TAG: /* Any_ty */ 12,
...
function fmtty_of_padding_fmtty(pad, fmtty) {
  if (typeof pad !== "object" && typeof pad !== "function" || pad.TAG === /* Lit_padding */ 0) {
    return fmtty;
  } else {
    return {
      TAG: /* Int_ty */ 2,
...
function fmtty_of_precision_fmtty(prec, fmtty) {
  if (typeof prec !== "object" && typeof prec !== "function" && prec !== /* No_precision */ 0) {
    return {
      TAG: /* Int_ty */ 2,
      _0: fmtty
    };
...
function type_ignored_format_substitution(sub_fmtty, fmt, fmtty) {
  if (typeof sub_fmtty !== "object" && typeof sub_fmtty !== "function") {
    return {
      TAG: /* Fmtty_fmt_EBB */ 0,
      _0: /* End_of_fmtty */ 0,
...
function type_format_gen(fmt, fmtty) {
  if (typeof fmt !== "object" && typeof fmt !== "function") {
    return {
      TAG: /* Fmt_fmtty_EBB */ 0,
      _0: /* End_of_format */ 0,
      _1: fmtty
  ...
  switch (fmt.TAG) {
    ...
    case /* String */ 2 :
      ...
      if (typeof fmtty_rest !== "object" && typeof fmtty_rest !== "function") {
        throw new Caml_js_exceptions.MelangeError(Type_mismatch, {
            MEL_EXN_ID: Type_mismatch
          });
      }
    ...
    case /* Caml_string */ 3 :
      ...
      if (typeof fmtty_rest$1 !== "object" && typeof fmtty_rest$1 !== "function") {
        throw new Caml_js_exceptions.MelangeError(Type_mismatch, {
            MEL_EXN_ID: Type_mismatch
          });
      }
    ...
    case /* Int */ 4 :
      ...
      if (typeof fmtty_rest$2 !== "object" && typeof fmtty_rest$2 !== "function") {
        throw new Caml_js_exceptions.MelangeError(Type_mismatch, {
            MEL_EXN_ID: Type_mismatch
          });
      }
    ...
    case /* Int32 */ 5 :
      ...
      if (typeof fmtty_rest$3 !== "object" && typeof fmtty_rest$3 !== "function") {
        throw new Caml_js_exceptions.MelangeError(Type_mismatch, {
            MEL_EXN_ID: Type_mismatch
          });
      }
    ...
    case /* Nativeint */ 6 :
      ...
      if (typeof fmtty_rest$4 !== "object" && typeof fmtty_rest$4 !== "function") {
        throw new Caml_js_exceptions.MelangeError(Type_mismatch, {
            MEL_EXN_ID: Type_mismatch
          });
      }
    ...
    case /* Int64 */ 7 :
      ...
      if (typeof fmtty_rest$5 !== "object" && typeof fmtty_rest$5 !== "function") {
        throw new Caml_js_exceptions.MelangeError(Type_mismatch, {
            MEL_EXN_ID: Type_mismatch
          });
      }
    ...
    case /* Float */ 8 :
      ...
      if (typeof fmtty_rest$6 !== "object" && typeof fmtty_rest$6 !== "function") {
        throw new Caml_js_exceptions.MelangeError(Type_mismatch, {
            MEL_EXN_ID: Type_mismatch
          });
      }
    ...
    case /* Bool */ 9 :
      ...
      if (typeof fmtty_rest$7 !== "object" && typeof fmtty_rest$7 !== "function") {
        throw new Caml_js_exceptions.MelangeError(Type_mismatch, {
            MEL_EXN_ID: Type_mismatch
          });
      }
  ...
  while (true) {
    ...
    switch (fmt.TAG) {
      case /* String */ 2 :
        let exit$1 = 0;
        let tmp = fmt._0;
        if (typeof tmp !== "object" && typeof tmp !== "function" || tmp.TAG === /* Lit_padding */ 0) {
          exit$1 = 4;
        } else {
      ...
      case /* Caml_string */ 3 :
        let exit$2 = 0;
        let tmp$1 = fmt._0;
        if (typeof tmp$1 !== "object" && typeof tmp$1 !== "function" || tmp$1.TAG === /* Lit_padding */ 0) {
          exit$2 = 4;
        } else {
      ...
      case /* Bool */ 9 :
        let exit$3 = 0;
        let tmp$2 = fmt._0;
        if (typeof tmp$2 !== "object" && typeof tmp$2 !== "function" || tmp$2.TAG === /* Lit_padding */ 0) {
          exit$3 = 4;
        } else {
      ...
      default:
        ...
        } else if (typeof prec !== "object" && typeof prec !== "function") {
          if (prec === /* No_precision */ 0) {
