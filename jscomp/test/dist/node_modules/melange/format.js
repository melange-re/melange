...
const CamlinternalFormat = require("./camlinternalFormat.js");
...
const Stdlib__Queue = require("./queue.js");
const Stdlib__Seq = require("./seq.js");
const Stdlib__Stack = require("./stack.js");
...
function output_formatting_lit(ppf, fmting_lit) {
  if (typeof fmting_lit !== "object" && typeof fmting_lit !== "function") {
    switch (fmting_lit) {
      case /* Close_box */ 0 :
...
function output_acc(ppf, acc) {
  ...
  switch (acc.TAG) {
    ...
    case /* Acc_string_literal */ 2 :
      const p$3 = acc._0;
      let exit$1 = 0;
      if (typeof p$3 !== "object" && typeof p$3 !== "function" || p$3.TAG !== /* Acc_formatting_lit */ 0) {
        exit$1 = 3;
      } else {
        const match$1 = p$3._1;
        if (typeof match$1 !== "object" && typeof match$1 !== "function" || match$1.TAG !== /* Magic_size */ 1) {
          exit$1 = 3;
        } else {
          p = p$3._0;
          size = match$1._1;
    ...
    case /* Acc_char_literal */ 3 :
      const p$4 = acc._0;
      let exit$2 = 0;
      if (typeof p$4 !== "object" && typeof p$4 !== "function" || p$4.TAG !== /* Acc_formatting_lit */ 0) {
        exit$2 = 3;
      } else {
        const match$2 = p$4._1;
        if (typeof match$2 !== "object" && typeof match$2 !== "function" || match$2.TAG !== /* Magic_size */ 1) {
          exit$2 = 3;
        } else {
          p$1 = p$4._0;
          size$1 = match$2._1;
    ...
    case /* Acc_data_string */ 4 :
      const p$5 = acc._0;
      let exit$3 = 0;
      if (typeof p$5 !== "object" && typeof p$5 !== "function" || p$5.TAG !== /* Acc_formatting_lit */ 0) {
        exit$3 = 3;
      } else {
        const match$3 = p$5._1;
        if (typeof match$3 !== "object" && typeof match$3 !== "function" || match$3.TAG !== /* Magic_size */ 1) {
          exit$3 = 3;
        } else {
          p = p$5._0;
          size = match$3._1;
    ...
    case /* Acc_data_char */ 5 :
      const p$6 = acc._0;
      let exit$4 = 0;
      if (typeof p$6 !== "object" && typeof p$6 !== "function" || p$6.TAG !== /* Acc_formatting_lit */ 0) {
        exit$4 = 3;
      } else {
        const match$4 = p$6._1;
        if (typeof match$4 !== "object" && typeof match$4 !== "function" || match$4.TAG !== /* Magic_size */ 1) {
          exit$4 = 3;
        } else {
          p$1 = p$6._0;
          size$1 = match$4._1;
...
function strput_acc(ppf, acc) {
  ...
  switch (acc.TAG) {
    ...
    case /* Acc_delay */ 6 :
      const p$7 = acc._0;
      let exit$5 = 0;
      if (typeof p$7 !== "object" && typeof p$7 !== "function" || p$7.TAG !== /* Acc_formatting_lit */ 0) {
        exit$5 = 3;
      } else {
