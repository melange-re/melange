...
function insert_all_buckets(indexfun, inplace, odata, ndata) {
  ...
  const insert_bucket = function (_cell) {
    while (true) {
      const cell = _cell;
      if (typeof cell !== "object" && typeof cell !== "function") {
        return;
      }
      const key = cell.key;
      ...
      if (typeof tail !== "object" && typeof tail !== "function") {
...
function filter_map_inplace_bucket(f, h, i, _prec, _slot) {
  while (true) {
    const slot = _slot;
    const prec = _prec;
    if (typeof slot !== "object" && typeof slot !== "function") {
      if (typeof prec !== "object" && typeof prec !== "function") {
...
function to_seq(tbl) {
  ...
  const aux = function (_i, _buck, _param) {
    while (true) {
      const buck = _buck;
      const i = _i;
      if (typeof buck !== "object" && typeof buck !== "function") {
...
function MakeSeeded(H) {
  ...
  const find = function (h, key) {
    ...
    if (typeof next1 !== "object" && typeof next1 !== "function") {
      throw new Caml_js_exceptions.MelangeError(Stdlib.Not_found, {
          MEL_EXN_ID: Stdlib.Not_found
        });
    }
    ...
    if (typeof next2 !== "object" && typeof next2 !== "function") {
      throw new Caml_js_exceptions.MelangeError(Stdlib.Not_found, {
          MEL_EXN_ID: Stdlib.Not_found
        });
    }
