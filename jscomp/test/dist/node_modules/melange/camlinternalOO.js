...
function set_data(tables, v) {
  if (!(typeof tables !== "object" && typeof tables !== "function")) {
    tables.data = v;
    return;
  }
  throw new Caml_js_exceptions.MelangeError("Assert_failure", {
...
function lookup_keys(i, keys, tables) {
  ...
  while (true) {
    ...
    if (get_key(tables$1) === key) {
      ...
      if (!(typeof tables_data !== "object" && typeof tables_data !== "function")) {
...
function lookup_tables(root, keys) {
  ...
  if (typeof root_data !== "object" && typeof root_data !== "function") {
