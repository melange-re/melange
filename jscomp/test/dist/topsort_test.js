...
function dfs1(_nodes, graph, _visited) {
  while (true) {
    ...
    const nodes = _nodes;
    if (!nodes) {
      return Stdlib__List.rev(visited);
    }
    const xs = nodes.tl;
    const x = nodes.hd;
    if (Stdlib__List.mem(x, visited)) {
      _nodes = xs;
      continue;
    }
    console.log(x);
...
function dfs2(nodes, graph, visited) {
  const aux = function (_nodes, graph, _visited) {
    while (true) {
      const visited = _visited;
      const nodes = _nodes;
      if (!nodes) {
  ...
  return Stdlib__List.rev(aux(nodes, graph, visited));
}
...
function concat(t1, t2) {
  if (/* tag */ typeof t1 !== "object" && typeof t1 !== "function") {
    return t2;
  } else if (/* tag */ typeof t2 !== "object" && typeof t2 !== "function") {
    return t1;
  } else {
...
function remove(x, t) {
  ...
  if (c === 0) {
    if (/* tag */ typeof l !== "object" && typeof l !== "function") {
      return r;
    } else if (/* tag */ typeof r !== "object" && typeof r !== "function") {
      return l;
    } else {
...
function compare(s1, s2) {
  ...
  while (true) {
    const e2 = _e2;
    const e1 = _e1;
    if (/* tag */ typeof e1 !== "object" && typeof e1 !== "function") {
      if (/* tag */ typeof e2 !== "object" && typeof e2 !== "function") {
        return 0;
      } else {
        return -1;
      }
...
function filter_map(f, t) {
  ...
  if (v$p === undefined) {
    if (/* tag */ typeof l$p !== "object" && typeof l$p !== "function") {
      return r$p;
    } else if (/* tag */ typeof r$p !== "object" && typeof r$p !== "function") {
      return l$p;
    } else {
...
const Cycle = /* @__PURE__ */ Caml_exceptions.create("Topsort_test.Cycle");

function pathsort(graph) {
  const visited = {
    contents: /* [] */ 0
  };
  const empty_path_0 = /* Empty */ 0;
  const empty_path = [
    empty_path_0,
    /* [] */ 0
  ];
  const $plus$great = function (node, param) {
    const stack = param[1];
    const set = param[0];
