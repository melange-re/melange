...
function string_of_rank(i) {
  if (/* tag */ typeof i !== "object" && typeof i !== "function") {
...
function merge(t1, t2) {
  ...
  if (/* tag */ typeof t2 !== "object" && typeof t2 !== "function") {
    return t1;
  }
...
function compute_update_sequences(all_tickers) {
  Stdlib__List.fold_left((function (counter, ticker) {
    const loop = function (counter, ticker) {
      ...
      if (!/* tag */ (typeof rank !== "object" && typeof rank !== "function")) {
        return counter;
      }
  ...
  const map = Stdlib__List.fold_left((function (map, ticker) {
    ...
    const loop = function (_up, _map, _ticker) {
      while (true) {
        ...
        if (/* tag */ typeof type_ !== "object" && typeof type_ !== "function") {
  ...
  return Curry._3(fold, (function (k, l, map) {
    const l$1 = Stdlib__List.sort_uniq((function (lhs, rhs) {
      ...
      if (/* tag */ typeof x !== "object" && typeof x !== "function") {
        ...
        const y = rhs.rank;
        if (!/* tag */ (typeof y !== "object" && typeof y !== "function")) {
