...
val cmpU : ('k, 'v, 'id) t -> ('k, 'v, 'id) t -> (('v -> 'v -> int)[@bs]) -> int
...
val eqU :
  ('k, 'v, 'id) t -> ('k, 'v, 'id) t -> (('v -> 'v -> bool)[@bs]) -> bool
...
val reduceU :
  ('k, 'v, 'id) t -> 'acc -> (('acc -> 'k -> 'v -> 'acc)[@bs]) -> 'acc
...
val updateU :
  ('k, 'v, 'id) t -> 'k -> (('v option -> 'v option)[@bs]) -> ('k, 'v, 'id) t
...
val keepU : ('k, 'v, 'id) t -> (('k -> 'v -> bool)[@bs]) -> ('k, 'v, 'id) t
