...
val mergeMany :
  ('value, 'id) t -> 'value array -> cmp:('value, 'id) cmp -> ('value, 'id) t

val remove :
  ('value, 'id) t -> 'value -> cmp:('value, 'id) cmp -> ('value, 'id) t
...
val union :
  ('value, 'id) t -> ('value, 'id) t -> cmp:('value, 'id) cmp -> ('value, 'id) t
...
val getUndefined :
  ('value, 'id) t -> 'value -> cmp:('value, 'id) cmp -> 'value Js.undefined
