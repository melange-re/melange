        ...
        fun rhs ->
          ...
          | (T_NUMBER { kind = lhskind; raw = lhsraw }, T_NUMBER
             { kind = rhskind; raw = rhsraw }) ->
              (__0 lhskind rhskind) &&
                (((fun (a : string) -> fun b -> a = b)) lhsraw rhsraw)
          | (T_BIGINT { kind = lhskind; raw = lhsraw }, T_BIGINT
             { kind = rhskind; raw = rhsraw }) ->
              (__1 lhskind rhskind) &&
                (((fun (a : string) -> fun b -> a = b)) lhsraw rhsraw)
          | (T_STRING lhs0, T_STRING rhs0) ->
              ((fun (lhs0, lhs1, lhs2, lhs3) ->
                  fun (rhs0, rhs1, rhs2, rhs3) ->
                    (((__2 lhs0 rhs0) &&
                        ((fun (a : string) -> fun b -> a = b) lhs1 rhs1))
                       && ((fun (a : string) -> fun b -> a = b) lhs2 rhs2))
                      && ((fun (a : bool) -> fun b -> a = b) lhs3 rhs3)))
                lhs0 rhs0
          | (T_TEMPLATE_PART lhs0, T_TEMPLATE_PART rhs0) ->
              ((fun (lhs0, lhs1, lhs2, lhs3, lhs4) ->
                  fun (rhs0, rhs1, rhs2, rhs3, rhs4) ->
                    ((((__3 lhs0 rhs0) &&
                         ((fun (a : string) -> fun b -> a = b) lhs1 rhs1))
                        && ((fun (a : string) -> fun b -> a = b) lhs2 rhs2))
                       && ((fun (a : bool) -> fun b -> a = b) lhs3 rhs3))
                      && ((fun (a : bool) -> fun b -> a = b) lhs4 rhs4)))
                lhs0 rhs0
          | (T_IDENTIFIER { loc = lhsloc; value = lhsvalue; raw = lhsraw },
             T_IDENTIFIER { loc = rhsloc; value = rhsvalue; raw = rhsraw })
              ->
              ((__4 lhsloc rhsloc) &&
                 ((fun (a : string) -> fun b -> a = b) lhsvalue rhsvalue))
                && (((fun (a : string) -> fun b -> a = b)) lhsraw rhsraw)
          ...
          | (T_NUMBER_SINGLETON_TYPE
             ...
             { kind = rhskind; value = rhsvalue; raw = rhsraw }) ->
              ((__11 lhskind rhskind) &&
                 ((fun (a : float) -> fun b -> a = b) lhsvalue rhsvalue))
                && (((fun (a : string) -> fun b -> a = b)) lhsraw rhsraw)
