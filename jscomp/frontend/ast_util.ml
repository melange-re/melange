  ...
  *)
  ...
  let generate_val_method_pair
    ...
    (Ast_compatible.object_field val_name [] result  ::
     (if is_mutable then
       [ Ast_compatible.object_field {val_name with txt = val_name.txt ^ Literals.setter_suffix} []
        ...
        | Pcf_method (
          ...
          begin match e.pexp_desc with
            | Pexp_poly
              ...
              (Ast_compatible.object_field label [] method_type :: label_attr_types),
              (if public_flag = Public then
                 Ast_compatible.object_field label [] method_type :: public_label_attr_types
               else
