...
let build_variant_constant_switch (fail : lam option) (arg : lam)
...
let make_test_sequence_variant_constant = build_variant_constant_switch
...
let call_switcher_variant_constant (_loc : Debuginfo.Scoped_location.t)
  ...
  build_variant_constant_switch fail arg int_lambda_list
