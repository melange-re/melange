  ...
  *)
  ...
  | Pctconst ct -> (
      ...
      | Standard_library_default ->
          E.string_equal ~loc
            (E.runtime_call ~loc Js_runtime_modules.sys
               "standard_library_deault" args)
            E.unit)
  | Pbswap16 ->
      E.runtime_call ~loc Js_runtime_modules.bytes "bswap16" args
  | Pbbswap Pnativeint -> assert false
  | Pbbswap Pint32 ->
      E.runtime_call ~loc Js_runtime_modules.bytes "bswap32" args
  | Popaque -> List.hd args
  | Pbbswap Pint64 ->
      E.runtime_call ~loc Js_runtime_modules.bytes "bswap64" args
