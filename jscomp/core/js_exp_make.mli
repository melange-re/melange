...
val int_comp : Lam_compat.integer_comparison -> ?comment:string -> t -> t -> t
val bool_comp : Lam_compat.integer_comparison -> ?comment:string -> t -> t -> t
val string_comp : Js_op.binop -> ?comment:string -> t -> t -> t
val float_comp :  Lam_compat.float_comparison -> ?comment:string -> t -> t -> t
val js_comp :  Lam_compat.integer_comparison -> ?comment:string -> t -> t -> t
