...
val ocaml_fun : ?loc:Location.t -> ?comment:string ->
  ?immutable_mask:bool array -> J.ident list -> J.block -> t

val method_ : ?loc:Location.t -> ?comment:string ->
  ?immutable_mask:bool array -> J.ident list -> J.block -> t
...
(* val var_dot : ?loc:Location.t -> ?comment:string -> Ident.t -> string -> t *)
...
val is_type_number :
  ?loc:Location.t -> ?comment:string -> t -> t
val is_type_string :
  ?loc:Location.t -> ?comment:string -> t -> t
