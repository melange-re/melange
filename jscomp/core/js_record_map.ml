...
|Debugger as v -> v 
 let expression : expression fn  = fun _self { expression_desc = _x0;comment = _x1;loc = _x2} -> begin let _x0 = expression_desc _self _x0 in  {expression_desc = _x0;comment = _x1;loc = _x2} end 
 let statement : statement fn  = fun _self { statement_desc = _x0;comment = _x1;loc = _x2} -> begin let _x0 = statement_desc _self _x0 in  {statement_desc = _x0;comment = _x1;loc = _x2} end 
