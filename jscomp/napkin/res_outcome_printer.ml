...
(* Oprint.out_class_type *)
   let setup  = lazy begin
    ...
    Oprint.out_value := wrap copy_out_value printOutValue;
    Oprint.out_type := wrap copy_out_type printOutType;
    Oprint.out_module_type := wrap copy_out_module_type printOutModuleType;
    Oprint.out_sig_item := wrap copy_out_sig_item printOutSigItem;
    Oprint.out_signature := wrap (List.map copy_out_sig_item) printOutSignature;
