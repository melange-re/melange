...
let bs_get : attr =
  {
    attr_name = { txt = "bs.get"; loc = locg };
    attr_payload = Ast_payload.empty;
    attr_loc = locg;
  }

let bs_get_index : attr =
  {
    attr_name = { txt = "bs.get_index"; loc = locg };
    attr_payload = Ast_payload.empty;
    attr_loc = locg;
  }
...
let internal_expansive : attr =
  {
    attr_name = { txt = "internal.expansive"; loc = locg };
    attr_payload = Ast_payload.empty;
    attr_loc = locg;
  }
